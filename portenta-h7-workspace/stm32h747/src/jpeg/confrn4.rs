...
pub type R = crate::R<CONFRN4_SPEC>;
#[doc = "Register `CONFRN4` writer"]
pub type W = crate::W<CONFRN4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hd(&mut self) -> HD_W<CONFRN4_SPEC, 0> {
        HD_W::new(self)
    }
    #[doc = "Bit 1 - Huffman AC Selects the Huffman table for encoding the AC coefficients."]
    #[inline(always)]
    #[must_use]
    pub fn ha(&mut self) -> HA_W<CONFRN4_SPEC, 1> {
        HA_W::new(self)
    }
    #[doc = "Bits 2:3 - Quantization Table Selects quantization table associated with a color component."]
    #[inline(always)]
    #[must_use]
    pub fn qt(&mut self) -> QT_W<CONFRN4_SPEC, 2> {
        QT_W::new(self)
    }
    #[doc = "Bits 4:7 - Number of Block Number of data units minus 1 that belong to a particular color in the MCU."]
    #[inline(always)]
    #[must_use]
    pub fn nb(&mut self) -> NB_W<CONFRN4_SPEC, 4> {
        NB_W::new(self)
    }
    #[doc = "Bits 8:11 - Vertical Sampling Factor Vertical sampling factor for component i."]
    #[inline(always)]
    #[must_use]
    pub fn vsf(&mut self) -> VSF_W<CONFRN4_SPEC, 8> {
        VSF_W::new(self)
    }
    #[doc = "Bits 12:15 - Horizontal Sampling Factor Horizontal sampling factor for component i."]
    #[inline(always)]
    #[must_use]
    pub fn hsf(&mut self) -> HSF_W<CONFRN4_SPEC, 12> {
        HSF_W::new(self)
    }
