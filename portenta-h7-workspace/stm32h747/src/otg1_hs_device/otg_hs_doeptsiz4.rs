...
pub type R = crate::R<OTG_HS_DOEPTSIZ4_SPEC>;
#[doc = "Register `OTG_HS_DOEPTSIZ4` writer"]
pub type W = crate::W<OTG_HS_DOEPTSIZ4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<OTG_HS_DOEPTSIZ4_SPEC, 0> {
        XFRSIZ_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<OTG_HS_DOEPTSIZ4_SPEC, 19> {
        PKTCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - Received data PID/SETUP packet count"]
    #[inline(always)]
    #[must_use]
    pub fn rxdpid_stupcnt(&mut self) -> RXDPID_STUPCNT_W<OTG_HS_DOEPTSIZ4_SPEC, 29> {
