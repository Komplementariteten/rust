...
pub type R = crate::R<OTG_HS_DOEPINT5_SPEC>;
#[doc = "Register `OTG_HS_DOEPINT5` writer"]
pub type W = crate::W<OTG_HS_DOEPINT5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrc(&mut self) -> XFRC_W<OTG_HS_DOEPINT5_SPEC, 0> {
        XFRC_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn epdisd(&mut self) -> EPDISD_W<OTG_HS_DOEPINT5_SPEC, 1> {
        EPDISD_W::new(self)
    }
    #[doc = "Bit 3 - SETUP phase done"]
    #[inline(always)]
    #[must_use]
    pub fn stup(&mut self) -> STUP_W<OTG_HS_DOEPINT5_SPEC, 3> {
        STUP_W::new(self)
    }
    #[doc = "Bit 4 - OUT token received when endpoint disabled"]
    #[inline(always)]
    #[must_use]
    pub fn otepdis(&mut self) -> OTEPDIS_W<OTG_HS_DOEPINT5_SPEC, 4> {
        OTEPDIS_W::new(self)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received"]
    #[inline(always)]
    #[must_use]
    pub fn b2bstup(&mut self) -> B2BSTUP_W<OTG_HS_DOEPINT5_SPEC, 6> {
        B2BSTUP_W::new(self)
    }
    #[doc = "Bit 14 - NYET interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<OTG_HS_DOEPINT5_SPEC, 14> {
        NYET_W::new(self)
    }
