...
pub type R = crate::R<OTG_HS_DIEPINT7_SPEC>;
#[doc = "Register `OTG_HS_DIEPINT7` writer"]
pub type W = crate::W<OTG_HS_DIEPINT7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrc(&mut self) -> XFRC_W<OTG_HS_DIEPINT7_SPEC, 0> {
        XFRC_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn epdisd(&mut self) -> EPDISD_W<OTG_HS_DIEPINT7_SPEC, 1> {
        EPDISD_W::new(self)
    }
    #[doc = "Bit 3 - Timeout condition"]
    #[inline(always)]
    #[must_use]
    pub fn toc(&mut self) -> TOC_W<OTG_HS_DIEPINT7_SPEC, 3> {
        TOC_W::new(self)
    }
    #[doc = "Bit 4 - IN token received when TxFIFO is empty"]
    #[inline(always)]
    #[must_use]
    pub fn ittxfe(&mut self) -> ITTXFE_W<OTG_HS_DIEPINT7_SPEC, 4> {
        ITTXFE_W::new(self)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    #[must_use]
    pub fn inepne(&mut self) -> INEPNE_W<OTG_HS_DIEPINT7_SPEC, 6> {
        INEPNE_W::new(self)
    }
    #[doc = "Bit 8 - Transmit Fifo Underrun"]
    #[inline(always)]
    #[must_use]
    pub fn txfifoudrn(&mut self) -> TXFIFOUDRN_W<OTG_HS_DIEPINT7_SPEC, 8> {
        TXFIFOUDRN_W::new(self)
    }
    #[doc = "Bit 9 - Buffer not available interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn bna(&mut self) -> BNA_W<OTG_HS_DIEPINT7_SPEC, 9> {
        BNA_W::new(self)
    }
    #[doc = "Bit 11 - Packet dropped status"]
    #[inline(always)]
    #[must_use]
    pub fn pktdrpsts(&mut self) -> PKTDRPSTS_W<OTG_HS_DIEPINT7_SPEC, 11> {
        PKTDRPSTS_W::new(self)
    }
    #[doc = "Bit 12 - Babble error interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn berr(&mut self) -> BERR_W<OTG_HS_DIEPINT7_SPEC, 12> {
        BERR_W::new(self)
    }
    #[doc = "Bit 13 - NAK interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<OTG_HS_DIEPINT7_SPEC, 13> {
        NAK_W::new(self)
    }
