...
pub type R = crate::R<OTG_HS_DIEPTSIZ7_SPEC>;
#[doc = "Register `OTG_HS_DIEPTSIZ7` writer"]
pub type W = crate::W<OTG_HS_DIEPTSIZ7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<OTG_HS_DIEPTSIZ7_SPEC, 0> {
        XFRSIZ_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<OTG_HS_DIEPTSIZ7_SPEC, 19> {
        PKTCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - Multi count"]
    #[inline(always)]
    #[must_use]
    pub fn mcnt(&mut self) -> MCNT_W<OTG_HS_DIEPTSIZ7_SPEC, 29> {
        MCNT_W::new(self)
    }
