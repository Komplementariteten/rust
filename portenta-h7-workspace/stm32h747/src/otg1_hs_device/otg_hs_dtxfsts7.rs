...
pub type R = crate::R<OTG_HS_DTXFSTS7_SPEC>;
#[doc = "Register `OTG_HS_DTXFSTS7` writer"]
pub type W = crate::W<OTG_HS_DTXFSTS7_SPEC>;
...
pub type INEPTFSAV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ineptfsav(&mut self) -> INEPTFSAV_W<OTG_HS_DTXFSTS7_SPEC, 0> {
