...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn brgen(&mut self) -> BRGEN_W<CFGR2_SPEC, 1> {
        BRGEN_W::new(self)
    }
    #[doc = "Bit 2 - Voltage scaler enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn scalen(&mut self) -> SCALEN_W<CFGR2_SPEC, 2> {
        SCALEN_W::new(self)
    }
    #[doc = "Bit 3 - COMP channel 1 polarity selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn polarity(&mut self) -> POLARITY_W<CFGR2_SPEC, 3> {
        POLARITY_W::new(self)
    }
    #[doc = "Bit 4 - Window comparator mode selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn winmode(&mut self) -> WINMODE_W<CFGR2_SPEC, 4> {
        WINMODE_W::new(self)
    }
    #[doc = "Bit 6 - COMP channel 1 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn iten(&mut self) -> ITEN_W<CFGR2_SPEC, 6> {
        ITEN_W::new(self)
    }
    #[doc = "Bits 8:9 - COMP channel 1 hysteresis selection bits"]
    #[inline(always)]
    #[must_use]
    pub fn hyst(&mut self) -> HYST_W<CFGR2_SPEC, 8> {
        HYST_W::new(self)
    }
    #[doc = "Bits 12:13 - Power Mode of the COMP channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn pwrmode(&mut self) -> PWRMODE_W<CFGR2_SPEC, 12> {
        PWRMODE_W::new(self)
    }
    #[doc = "Bits 16:18 - COMP channel 1 inverting input selection field"]
    #[inline(always)]
    #[must_use]
    pub fn inmsel(&mut self) -> INMSEL_W<CFGR2_SPEC, 16> {
        INMSEL_W::new(self)
    }
    #[doc = "Bit 20 - COMP channel 1 non-inverting input selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn inpsel(&mut self) -> INPSEL_W<CFGR2_SPEC, 20> {
        INPSEL_W::new(self)
    }
    #[doc = "Bits 24:27 - COMP channel 1 blanking source selection bits"]
    #[inline(always)]
    #[must_use]
    pub fn blanking(&mut self) -> BLANKING_W<CFGR2_SPEC, 24> {
        BLANKING_W::new(self)
    }
    #[doc = "Bit 31 - Lock bit"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<CFGR2_SPEC, 31> {
        LOCK_W::new(self)
    }
