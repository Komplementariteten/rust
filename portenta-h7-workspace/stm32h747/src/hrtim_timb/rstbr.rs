...
pub type R = crate::R<RSTBR_SPEC>;
#[doc = "Register `RSTBR` writer"]
pub type W = crate::W<RSTBR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn updt(&mut self) -> UPDT_W<RSTBR_SPEC, 1> {
        UPDT_W::new(self)
    }
    #[doc = "Bit 2 - Timer A compare 2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<RSTBR_SPEC, 2> {
        CMP2_W::new(self)
    }
    #[doc = "Bit 3 - Timer A compare 4 reset"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> CMP4_W<RSTBR_SPEC, 3> {
        CMP4_W::new(self)
    }
    #[doc = "Bit 4 - Master timer Period"]
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MSTPER_W<RSTBR_SPEC, 4> {
        MSTPER_W::new(self)
    }
    #[doc = "Bit 5 - Master compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> MSTCMP1_W<RSTBR_SPEC, 5> {
        MSTCMP1_W::new(self)
    }
    #[doc = "Bit 6 - Master compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> MSTCMP2_W<RSTBR_SPEC, 6> {
        MSTCMP2_W::new(self)
    }
    #[doc = "Bit 7 - Master compare 3"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> MSTCMP3_W<RSTBR_SPEC, 7> {
        MSTCMP3_W::new(self)
    }
    #[doc = "Bit 8 - Master compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> MSTCMP4_W<RSTBR_SPEC, 8> {
        MSTCMP4_W::new(self)
    }
    #[doc = "Bit 9 - External Event 1"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> EXTEVNT1_W<RSTBR_SPEC, 9> {
        EXTEVNT1_W::new(self)
    }
    #[doc = "Bit 10 - External Event 2"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> EXTEVNT2_W<RSTBR_SPEC, 10> {
        EXTEVNT2_W::new(self)
    }
    #[doc = "Bit 11 - External Event 3"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> EXTEVNT3_W<RSTBR_SPEC, 11> {
        EXTEVNT3_W::new(self)
    }
    #[doc = "Bit 12 - External Event 4"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> EXTEVNT4_W<RSTBR_SPEC, 12> {
        EXTEVNT4_W::new(self)
    }
    #[doc = "Bit 13 - External Event 5"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> EXTEVNT5_W<RSTBR_SPEC, 13> {
        EXTEVNT5_W::new(self)
    }
    #[doc = "Bit 14 - External Event 6"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> EXTEVNT6_W<RSTBR_SPEC, 14> {
        EXTEVNT6_W::new(self)
    }
    #[doc = "Bit 15 - External Event 7"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> EXTEVNT7_W<RSTBR_SPEC, 15> {
        EXTEVNT7_W::new(self)
    }
    #[doc = "Bit 16 - External Event 8"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> EXTEVNT8_W<RSTBR_SPEC, 16> {
        EXTEVNT8_W::new(self)
    }
    #[doc = "Bit 17 - External Event 9"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> EXTEVNT9_W<RSTBR_SPEC, 17> {
        EXTEVNT9_W::new(self)
    }
    #[doc = "Bit 18 - External Event 10"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> EXTEVNT10_W<RSTBR_SPEC, 18> {
        EXTEVNT10_W::new(self)
    }
    #[doc = "Bit 19 - Timer A Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp1(&mut self) -> TIMACMP1_W<RSTBR_SPEC, 19> {
        TIMACMP1_W::new(self)
    }
    #[doc = "Bit 20 - Timer A Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp2(&mut self) -> TIMACMP2_W<RSTBR_SPEC, 20> {
        TIMACMP2_W::new(self)
    }
    #[doc = "Bit 21 - Timer A Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp4(&mut self) -> TIMACMP4_W<RSTBR_SPEC, 21> {
        TIMACMP4_W::new(self)
    }
    #[doc = "Bit 22 - Timer C Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timccmp1(&mut self) -> TIMCCMP1_W<RSTBR_SPEC, 22> {
        TIMCCMP1_W::new(self)
    }
    #[doc = "Bit 23 - Timer C Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timccmp2(&mut self) -> TIMCCMP2_W<RSTBR_SPEC, 23> {
        TIMCCMP2_W::new(self)
    }
    #[doc = "Bit 24 - Timer C Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timccmp4(&mut self) -> TIMCCMP4_W<RSTBR_SPEC, 24> {
        TIMCCMP4_W::new(self)
    }
    #[doc = "Bit 25 - Timer D Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp1(&mut self) -> TIMDCMP1_W<RSTBR_SPEC, 25> {
        TIMDCMP1_W::new(self)
    }
    #[doc = "Bit 26 - Timer D Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp2(&mut self) -> TIMDCMP2_W<RSTBR_SPEC, 26> {
        TIMDCMP2_W::new(self)
    }
    #[doc = "Bit 27 - Timer D Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp4(&mut self) -> TIMDCMP4_W<RSTBR_SPEC, 27> {
        TIMDCMP4_W::new(self)
    }
    #[doc = "Bit 28 - Timer E Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timecmp1(&mut self) -> TIMECMP1_W<RSTBR_SPEC, 28> {
        TIMECMP1_W::new(self)
    }
    #[doc = "Bit 29 - Timer E Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timecmp2(&mut self) -> TIMECMP2_W<RSTBR_SPEC, 29> {
        TIMECMP2_W::new(self)
    }
    #[doc = "Bit 30 - Timer E Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timecmp4(&mut self) -> TIMECMP4_W<RSTBR_SPEC, 30> {
        TIMECMP4_W::new(self)
    }
