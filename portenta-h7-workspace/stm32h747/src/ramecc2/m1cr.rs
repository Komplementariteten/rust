...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eccseie(&mut self) -> ECCSEIE_W<M1CR_SPEC, 2> {
        ECCSEIE_W::new(self)
    }
    #[doc = "Bit 3 - ECC double error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn eccdeie(&mut self) -> ECCDEIE_W<M1CR_SPEC, 3> {
        ECCDEIE_W::new(self)
    }
    #[doc = "Bit 4 - ECC double error on byte write (BW) interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn eccdebwie(&mut self) -> ECCDEBWIE_W<M1CR_SPEC, 4> {
        ECCDEBWIE_W::new(self)
    }
    #[doc = "Bit 5 - ECC error latching enable"]
    #[inline(always)]
    #[must_use]
    pub fn eccelen(&mut self) -> ECCELEN_W<M1CR_SPEC, 5> {
        ECCELEN_W::new(self)
    }
