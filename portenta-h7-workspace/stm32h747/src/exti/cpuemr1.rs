...
pub type R = crate::R<CPUEMR1_SPEC>;
#[doc = "Register `CPUEMR1` writer"]
pub type W = crate::W<CPUEMR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr0(&mut self) -> MR0_W<CPUEMR1_SPEC, 0> {
        MR0_W::new(self)
    }
    #[doc = "Bit 1 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr1(&mut self) -> MR1_W<CPUEMR1_SPEC, 1> {
        MR1_W::new(self)
    }
    #[doc = "Bit 2 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr2(&mut self) -> MR2_W<CPUEMR1_SPEC, 2> {
        MR2_W::new(self)
    }
    #[doc = "Bit 3 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr3(&mut self) -> MR3_W<CPUEMR1_SPEC, 3> {
        MR3_W::new(self)
    }
    #[doc = "Bit 4 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr4(&mut self) -> MR4_W<CPUEMR1_SPEC, 4> {
        MR4_W::new(self)
    }
    #[doc = "Bit 5 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr5(&mut self) -> MR5_W<CPUEMR1_SPEC, 5> {
        MR5_W::new(self)
    }
    #[doc = "Bit 6 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr6(&mut self) -> MR6_W<CPUEMR1_SPEC, 6> {
        MR6_W::new(self)
    }
    #[doc = "Bit 7 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr7(&mut self) -> MR7_W<CPUEMR1_SPEC, 7> {
        MR7_W::new(self)
    }
    #[doc = "Bit 8 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr8(&mut self) -> MR8_W<CPUEMR1_SPEC, 8> {
        MR8_W::new(self)
    }
    #[doc = "Bit 9 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr9(&mut self) -> MR9_W<CPUEMR1_SPEC, 9> {
        MR9_W::new(self)
    }
    #[doc = "Bit 10 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr10(&mut self) -> MR10_W<CPUEMR1_SPEC, 10> {
        MR10_W::new(self)
    }
    #[doc = "Bit 11 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr11(&mut self) -> MR11_W<CPUEMR1_SPEC, 11> {
        MR11_W::new(self)
    }
    #[doc = "Bit 12 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr12(&mut self) -> MR12_W<CPUEMR1_SPEC, 12> {
        MR12_W::new(self)
    }
    #[doc = "Bit 13 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr13(&mut self) -> MR13_W<CPUEMR1_SPEC, 13> {
        MR13_W::new(self)
    }
    #[doc = "Bit 14 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr14(&mut self) -> MR14_W<CPUEMR1_SPEC, 14> {
        MR14_W::new(self)
    }
    #[doc = "Bit 15 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr15(&mut self) -> MR15_W<CPUEMR1_SPEC, 15> {
        MR15_W::new(self)
    }
    #[doc = "Bit 16 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr16(&mut self) -> MR16_W<CPUEMR1_SPEC, 16> {
        MR16_W::new(self)
    }
    #[doc = "Bit 17 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr17(&mut self) -> MR17_W<CPUEMR1_SPEC, 17> {
        MR17_W::new(self)
    }
    #[doc = "Bit 18 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr18(&mut self) -> MR18_W<CPUEMR1_SPEC, 18> {
        MR18_W::new(self)
    }
    #[doc = "Bit 19 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr19(&mut self) -> MR19_W<CPUEMR1_SPEC, 19> {
        MR19_W::new(self)
    }
    #[doc = "Bit 20 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr20(&mut self) -> MR20_W<CPUEMR1_SPEC, 20> {
        MR20_W::new(self)
    }
    #[doc = "Bit 21 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr21(&mut self) -> MR21_W<CPUEMR1_SPEC, 21> {
        MR21_W::new(self)
    }
    #[doc = "Bit 22 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr22(&mut self) -> MR22_W<CPUEMR1_SPEC, 22> {
        MR22_W::new(self)
    }
    #[doc = "Bit 23 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr23(&mut self) -> MR23_W<CPUEMR1_SPEC, 23> {
        MR23_W::new(self)
    }
    #[doc = "Bit 24 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr24(&mut self) -> MR24_W<CPUEMR1_SPEC, 24> {
        MR24_W::new(self)
    }
    #[doc = "Bit 25 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr25(&mut self) -> MR25_W<CPUEMR1_SPEC, 25> {
        MR25_W::new(self)
    }
    #[doc = "Bit 26 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr26(&mut self) -> MR26_W<CPUEMR1_SPEC, 26> {
        MR26_W::new(self)
    }
    #[doc = "Bit 27 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr27(&mut self) -> MR27_W<CPUEMR1_SPEC, 27> {
        MR27_W::new(self)
    }
    #[doc = "Bit 28 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr28(&mut self) -> MR28_W<CPUEMR1_SPEC, 28> {
        MR28_W::new(self)
    }
    #[doc = "Bit 29 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr29(&mut self) -> MR29_W<CPUEMR1_SPEC, 29> {
        MR29_W::new(self)
    }
    #[doc = "Bit 30 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr30(&mut self) -> MR30_W<CPUEMR1_SPEC, 30> {
        MR30_W::new(self)
    }
    #[doc = "Bit 31 - CPU Event mask on Event input x"]
    #[inline(always)]
    #[must_use]
    pub fn mr31(&mut self) -> MR31_W<CPUEMR1_SPEC, 31> {
        MR31_W::new(self)
    }
