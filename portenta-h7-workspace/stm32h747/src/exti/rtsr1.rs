...
pub type TR20_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TR21_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tr0(&mut self) -> TR0_W<RTSR1_SPEC, 0> {
        TR0_W::new(self)
    }
    #[doc = "Bit 1 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr1(&mut self) -> TR1_W<RTSR1_SPEC, 1> {
        TR1_W::new(self)
    }
    #[doc = "Bit 2 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr2(&mut self) -> TR2_W<RTSR1_SPEC, 2> {
        TR2_W::new(self)
    }
    #[doc = "Bit 3 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr3(&mut self) -> TR3_W<RTSR1_SPEC, 3> {
        TR3_W::new(self)
    }
    #[doc = "Bit 4 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr4(&mut self) -> TR4_W<RTSR1_SPEC, 4> {
        TR4_W::new(self)
    }
    #[doc = "Bit 5 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr5(&mut self) -> TR5_W<RTSR1_SPEC, 5> {
        TR5_W::new(self)
    }
    #[doc = "Bit 6 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr6(&mut self) -> TR6_W<RTSR1_SPEC, 6> {
        TR6_W::new(self)
    }
    #[doc = "Bit 7 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr7(&mut self) -> TR7_W<RTSR1_SPEC, 7> {
        TR7_W::new(self)
    }
    #[doc = "Bit 8 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr8(&mut self) -> TR8_W<RTSR1_SPEC, 8> {
        TR8_W::new(self)
    }
    #[doc = "Bit 9 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr9(&mut self) -> TR9_W<RTSR1_SPEC, 9> {
        TR9_W::new(self)
    }
    #[doc = "Bit 10 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr10(&mut self) -> TR10_W<RTSR1_SPEC, 10> {
        TR10_W::new(self)
    }
    #[doc = "Bit 11 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr11(&mut self) -> TR11_W<RTSR1_SPEC, 11> {
        TR11_W::new(self)
    }
    #[doc = "Bit 12 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr12(&mut self) -> TR12_W<RTSR1_SPEC, 12> {
        TR12_W::new(self)
    }
    #[doc = "Bit 13 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr13(&mut self) -> TR13_W<RTSR1_SPEC, 13> {
        TR13_W::new(self)
    }
    #[doc = "Bit 14 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr14(&mut self) -> TR14_W<RTSR1_SPEC, 14> {
        TR14_W::new(self)
    }
    #[doc = "Bit 15 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr15(&mut self) -> TR15_W<RTSR1_SPEC, 15> {
        TR15_W::new(self)
    }
    #[doc = "Bit 16 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr16(&mut self) -> TR16_W<RTSR1_SPEC, 16> {
        TR16_W::new(self)
    }
    #[doc = "Bit 17 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr17(&mut self) -> TR17_W<RTSR1_SPEC, 17> {
        TR17_W::new(self)
    }
    #[doc = "Bit 18 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr18(&mut self) -> TR18_W<RTSR1_SPEC, 18> {
        TR18_W::new(self)
    }
    #[doc = "Bit 19 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr19(&mut self) -> TR19_W<RTSR1_SPEC, 19> {
        TR19_W::new(self)
    }
    #[doc = "Bit 20 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr20(&mut self) -> TR20_W<RTSR1_SPEC, 20> {
        TR20_W::new(self)
    }
    #[doc = "Bit 21 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn tr21(&mut self) -> TR21_W<RTSR1_SPEC, 21> {
        TR21_W::new(self)
    }
