...
pub type R = crate::R<CPUEMR3_SPEC>;
...
#[doc = "EXTI event mask register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpuemr3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
