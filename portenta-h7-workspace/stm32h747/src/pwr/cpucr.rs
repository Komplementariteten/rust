...
pub type R = crate::R<CPUCR_SPEC>;
#[doc = "Register `CPUCR` writer"]
pub type W = crate::W<CPUCR_SPEC>;
...
pub type PDDS_D1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PDDS_D2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PDDS_D3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CSSF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RUN_D3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pdds_d1(&mut self) -> PDDS_D1_W<CPUCR_SPEC, 0> {
        PDDS_D1_W::new(self)
    }
    #[doc = "Bit 1 - D2 domain Power Down Deepsleep. This bit allows CPU1 to define the Deepsleep mode for D2 domain."]
    #[inline(always)]
    #[must_use]
    pub fn pdds_d2(&mut self) -> PDDS_D2_W<CPUCR_SPEC, 1> {
        PDDS_D2_W::new(self)
    }
    #[doc = "Bit 2 - System D3 domain Power Down Deepsleep. This bit allows CPU1 to define the Deepsleep mode for System D3 domain."]
    #[inline(always)]
    #[must_use]
    pub fn pdds_d3(&mut self) -> PDDS_D3_W<CPUCR_SPEC, 2> {
        PDDS_D3_W::new(self)
    }
    #[doc = "Bit 9 - Clear D1 domain CPU1 Standby, Stop and HOLD flags (always read as 0) This bit is cleared to 0 by hardware."]
    #[inline(always)]
    #[must_use]
    pub fn cssf(&mut self) -> CSSF_W<CPUCR_SPEC, 9> {
        CSSF_W::new(self)
    }
    #[doc = "Bit 11 - Keep system D3 domain in Run mode regardless of the CPU sub-systems modes"]
    #[inline(always)]
    #[must_use]
    pub fn run_d3(&mut self) -> RUN_D3_W<CPUCR_SPEC, 11> {
        RUN_D3_W::new(self)
    }
