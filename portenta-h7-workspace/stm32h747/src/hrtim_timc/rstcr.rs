...
pub type MSTPER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EXTEVNT10_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMACMP1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMACMP2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMACMP4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMBCMP1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMBCMP2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMBCMP4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMDCMP1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMDCMP2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMDCMP4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMECMP1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMECMP2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMECMP4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn updt(&mut self) -> UPDT_W<RSTCR_SPEC, 1> {
        UPDT_W::new(self)
    }
    #[doc = "Bit 2 - Timer A compare 2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<RSTCR_SPEC, 2> {
        CMP2_W::new(self)
    }
    #[doc = "Bit 3 - Timer A compare 4 reset"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> CMP4_W<RSTCR_SPEC, 3> {
        CMP4_W::new(self)
    }
    #[doc = "Bit 4 - Master timer Period"]
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MSTPER_W<RSTCR_SPEC, 4> {
        MSTPER_W::new(self)
    }
    #[doc = "Bit 5 - Master compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> MSTCMP1_W<RSTCR_SPEC, 5> {
        MSTCMP1_W::new(self)
    }
    #[doc = "Bit 6 - Master compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> MSTCMP2_W<RSTCR_SPEC, 6> {
        MSTCMP2_W::new(self)
    }
    #[doc = "Bit 7 - Master compare 3"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> MSTCMP3_W<RSTCR_SPEC, 7> {
        MSTCMP3_W::new(self)
    }
    #[doc = "Bit 8 - Master compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> MSTCMP4_W<RSTCR_SPEC, 8> {
        MSTCMP4_W::new(self)
    }
    #[doc = "Bit 9 - External Event 1"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> EXTEVNT1_W<RSTCR_SPEC, 9> {
        EXTEVNT1_W::new(self)
    }
    #[doc = "Bit 10 - External Event 2"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> EXTEVNT2_W<RSTCR_SPEC, 10> {
        EXTEVNT2_W::new(self)
    }
    #[doc = "Bit 11 - External Event 3"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> EXTEVNT3_W<RSTCR_SPEC, 11> {
        EXTEVNT3_W::new(self)
    }
    #[doc = "Bit 12 - External Event 4"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> EXTEVNT4_W<RSTCR_SPEC, 12> {
        EXTEVNT4_W::new(self)
    }
    #[doc = "Bit 13 - External Event 5"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> EXTEVNT5_W<RSTCR_SPEC, 13> {
        EXTEVNT5_W::new(self)
    }
    #[doc = "Bit 14 - External Event 6"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> EXTEVNT6_W<RSTCR_SPEC, 14> {
        EXTEVNT6_W::new(self)
    }
    #[doc = "Bit 15 - External Event 7"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> EXTEVNT7_W<RSTCR_SPEC, 15> {
        EXTEVNT7_W::new(self)
    }
    #[doc = "Bit 16 - External Event 8"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> EXTEVNT8_W<RSTCR_SPEC, 16> {
        EXTEVNT8_W::new(self)
    }
    #[doc = "Bit 17 - External Event 9"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> EXTEVNT9_W<RSTCR_SPEC, 17> {
        EXTEVNT9_W::new(self)
    }
    #[doc = "Bit 18 - External Event 10"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> EXTEVNT10_W<RSTCR_SPEC, 18> {
        EXTEVNT10_W::new(self)
    }
    #[doc = "Bit 19 - Timer A Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp1(&mut self) -> TIMACMP1_W<RSTCR_SPEC, 19> {
        TIMACMP1_W::new(self)
    }
    #[doc = "Bit 20 - Timer A Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp2(&mut self) -> TIMACMP2_W<RSTCR_SPEC, 20> {
        TIMACMP2_W::new(self)
    }
    #[doc = "Bit 21 - Timer A Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp4(&mut self) -> TIMACMP4_W<RSTCR_SPEC, 21> {
        TIMACMP4_W::new(self)
    }
    #[doc = "Bit 22 - Timer B Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timbcmp1(&mut self) -> TIMBCMP1_W<RSTCR_SPEC, 22> {
        TIMBCMP1_W::new(self)
    }
    #[doc = "Bit 23 - Timer B Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timbcmp2(&mut self) -> TIMBCMP2_W<RSTCR_SPEC, 23> {
        TIMBCMP2_W::new(self)
    }
    #[doc = "Bit 24 - Timer B Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timbcmp4(&mut self) -> TIMBCMP4_W<RSTCR_SPEC, 24> {
        TIMBCMP4_W::new(self)
    }
    #[doc = "Bit 25 - Timer D Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp1(&mut self) -> TIMDCMP1_W<RSTCR_SPEC, 25> {
        TIMDCMP1_W::new(self)
    }
    #[doc = "Bit 26 - Timer D Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp2(&mut self) -> TIMDCMP2_W<RSTCR_SPEC, 26> {
        TIMDCMP2_W::new(self)
    }
    #[doc = "Bit 27 - Timer D Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp4(&mut self) -> TIMDCMP4_W<RSTCR_SPEC, 27> {
        TIMDCMP4_W::new(self)
    }
    #[doc = "Bit 28 - Timer E Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timecmp1(&mut self) -> TIMECMP1_W<RSTCR_SPEC, 28> {
        TIMECMP1_W::new(self)
    }
    #[doc = "Bit 29 - Timer E Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timecmp2(&mut self) -> TIMECMP2_W<RSTCR_SPEC, 29> {
        TIMECMP2_W::new(self)
    }
    #[doc = "Bit 30 - Timer E Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timecmp4(&mut self) -> TIMECMP4_W<RSTCR_SPEC, 30> {
        TIMECMP4_W::new(self)
    }
