...
pub type R = crate::R<CHPCR_SPEC>;
#[doc = "Register `CHPCR` writer"]
pub type W = crate::W<CHPCR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chpfrq(&mut self) -> CHPFRQ_W<CHPCR_SPEC, 0> {
        CHPFRQ_W::new(self)
    }
    #[doc = "Bits 4:6 - Timerx chopper duty cycle value"]
    #[inline(always)]
    #[must_use]
    pub fn chpdty(&mut self) -> CHPDTY_W<CHPCR_SPEC, 4> {
        CHPDTY_W::new(self)
    }
    #[doc = "Bits 7:10 - STRTPW"]
    #[inline(always)]
    #[must_use]
    pub fn strtpw(&mut self) -> STRTPW_W<CHPCR_SPEC, 7> {
        STRTPW_W::new(self)
    }
