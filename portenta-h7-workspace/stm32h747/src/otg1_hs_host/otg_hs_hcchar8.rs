...
pub type R = crate::R<OTG_HS_HCCHAR8_SPEC>;
#[doc = "Register `OTG_HS_HCCHAR8` writer"]
pub type W = crate::W<OTG_HS_HCCHAR8_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mpsiz(&mut self) -> MPSIZ_W<OTG_HS_HCCHAR8_SPEC, 0> {
        MPSIZ_W::new(self)
    }
    #[doc = "Bits 11:14 - Endpoint number"]
    #[inline(always)]
    #[must_use]
    pub fn epnum(&mut self) -> EPNUM_W<OTG_HS_HCCHAR8_SPEC, 11> {
        EPNUM_W::new(self)
    }
    #[doc = "Bit 15 - Endpoint direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<OTG_HS_HCCHAR8_SPEC, 15> {
        EPDIR_W::new(self)
    }
    #[doc = "Bit 17 - Low-speed device"]
    #[inline(always)]
    #[must_use]
    pub fn lsdev(&mut self) -> LSDEV_W<OTG_HS_HCCHAR8_SPEC, 17> {
        LSDEV_W::new(self)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn eptyp(&mut self) -> EPTYP_W<OTG_HS_HCCHAR8_SPEC, 18> {
        EPTYP_W::new(self)
    }
    #[doc = "Bits 20:21 - Multi Count (MC) / Error Count (EC)"]
    #[inline(always)]
    #[must_use]
    pub fn mc(&mut self) -> MC_W<OTG_HS_HCCHAR8_SPEC, 20> {
        MC_W::new(self)
    }
    #[doc = "Bits 22:28 - Device address"]
    #[inline(always)]
    #[must_use]
    pub fn dad(&mut self) -> DAD_W<OTG_HS_HCCHAR8_SPEC, 22> {
        DAD_W::new(self)
    }
    #[doc = "Bit 29 - Odd frame"]
    #[inline(always)]
    #[must_use]
    pub fn oddfrm(&mut self) -> ODDFRM_W<OTG_HS_HCCHAR8_SPEC, 29> {
        ODDFRM_W::new(self)
    }
    #[doc = "Bit 30 - Channel disable"]
    #[inline(always)]
    #[must_use]
    pub fn chdis(&mut self) -> CHDIS_W<OTG_HS_HCCHAR8_SPEC, 30> {
        CHDIS_W::new(self)
    }
    #[doc = "Bit 31 - Channel enable"]
    #[inline(always)]
    #[must_use]
    pub fn chena(&mut self) -> CHENA_W<OTG_HS_HCCHAR8_SPEC, 31> {
        CHENA_W::new(self)
    }
