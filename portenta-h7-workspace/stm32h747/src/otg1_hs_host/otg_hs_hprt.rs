...
pub type R = crate::R<OTG_HS_HPRT_SPEC>;
#[doc = "Register `OTG_HS_HPRT` writer"]
pub type W = crate::W<OTG_HS_HPRT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcdet(&mut self) -> PCDET_W<OTG_HS_HPRT_SPEC, 1> {
        PCDET_W::new(self)
    }
    #[doc = "Bit 2 - Port enable"]
    #[inline(always)]
    #[must_use]
    pub fn pena(&mut self) -> PENA_W<OTG_HS_HPRT_SPEC, 2> {
        PENA_W::new(self)
    }
    #[doc = "Bit 3 - Port enable/disable change"]
    #[inline(always)]
    #[must_use]
    pub fn penchng(&mut self) -> PENCHNG_W<OTG_HS_HPRT_SPEC, 3> {
        PENCHNG_W::new(self)
    }
    #[doc = "Bit 5 - Port overcurrent change"]
    #[inline(always)]
    #[must_use]
    pub fn pocchng(&mut self) -> POCCHNG_W<OTG_HS_HPRT_SPEC, 5> {
        POCCHNG_W::new(self)
    }
    #[doc = "Bit 6 - Port resume"]
    #[inline(always)]
    #[must_use]
    pub fn pres(&mut self) -> PRES_W<OTG_HS_HPRT_SPEC, 6> {
        PRES_W::new(self)
    }
    #[doc = "Bit 7 - Port suspend"]
    #[inline(always)]
    #[must_use]
    pub fn psusp(&mut self) -> PSUSP_W<OTG_HS_HPRT_SPEC, 7> {
        PSUSP_W::new(self)
    }
    #[doc = "Bit 8 - Port reset"]
    #[inline(always)]
    #[must_use]
    pub fn prst(&mut self) -> PRST_W<OTG_HS_HPRT_SPEC, 8> {
        PRST_W::new(self)
    }
    #[doc = "Bit 12 - Port power"]
    #[inline(always)]
    #[must_use]
    pub fn ppwr(&mut self) -> PPWR_W<OTG_HS_HPRT_SPEC, 12> {
        PPWR_W::new(self)
    }
    #[doc = "Bits 13:16 - Port test control"]
    #[inline(always)]
    #[must_use]
    pub fn ptctl(&mut self) -> PTCTL_W<OTG_HS_HPRT_SPEC, 13> {
        PTCTL_W::new(self)
    }
