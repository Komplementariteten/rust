...
pub type R = crate::R<OTG_HS_HCINTMSK4_SPEC>;
#[doc = "Register `OTG_HS_HCINTMSK4` writer"]
pub type W = crate::W<OTG_HS_HCINTMSK4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrcm(&mut self) -> XFRCM_W<OTG_HS_HCINTMSK4_SPEC, 0> {
        XFRCM_W::new(self)
    }
    #[doc = "Bit 1 - Channel halted mask"]
    #[inline(always)]
    #[must_use]
    pub fn chhm(&mut self) -> CHHM_W<OTG_HS_HCINTMSK4_SPEC, 1> {
        CHHM_W::new(self)
    }
    #[doc = "Bit 2 - AHB error"]
    #[inline(always)]
    #[must_use]
    pub fn ahberr(&mut self) -> AHBERR_W<OTG_HS_HCINTMSK4_SPEC, 2> {
        AHBERR_W::new(self)
    }
    #[doc = "Bit 3 - STALL response received interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn stallm(&mut self) -> STALLM_W<OTG_HS_HCINTMSK4_SPEC, 3> {
        STALLM_W::new(self)
    }
    #[doc = "Bit 4 - NAK response received interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn nakm(&mut self) -> NAKM_W<OTG_HS_HCINTMSK4_SPEC, 4> {
        NAKM_W::new(self)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn ackm(&mut self) -> ACKM_W<OTG_HS_HCINTMSK4_SPEC, 5> {
        ACKM_W::new(self)
    }
    #[doc = "Bit 6 - response received interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<OTG_HS_HCINTMSK4_SPEC, 6> {
        NYET_W::new(self)
    }
    #[doc = "Bit 7 - Transaction error mask"]
    #[inline(always)]
    #[must_use]
    pub fn txerrm(&mut self) -> TXERRM_W<OTG_HS_HCINTMSK4_SPEC, 7> {
        TXERRM_W::new(self)
    }
    #[doc = "Bit 8 - Babble error mask"]
    #[inline(always)]
    #[must_use]
    pub fn bberrm(&mut self) -> BBERRM_W<OTG_HS_HCINTMSK4_SPEC, 8> {
        BBERRM_W::new(self)
    }
    #[doc = "Bit 9 - Frame overrun mask"]
    #[inline(always)]
    #[must_use]
    pub fn frmorm(&mut self) -> FRMORM_W<OTG_HS_HCINTMSK4_SPEC, 9> {
        FRMORM_W::new(self)
    }
    #[doc = "Bit 10 - Data toggle error mask"]
    #[inline(always)]
    #[must_use]
    pub fn dterrm(&mut self) -> DTERRM_W<OTG_HS_HCINTMSK4_SPEC, 10> {
        DTERRM_W::new(self)
    }
