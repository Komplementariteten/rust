...
pub type R = crate::R<OTG_HS_HCSPLT9_SPEC>;
#[doc = "Register `OTG_HS_HCSPLT9` writer"]
pub type W = crate::W<OTG_HS_HCSPLT9_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prtaddr(&mut self) -> PRTADDR_W<OTG_HS_HCSPLT9_SPEC, 0> {
        PRTADDR_W::new(self)
    }
    #[doc = "Bits 7:13 - Hub address"]
    #[inline(always)]
    #[must_use]
    pub fn hubaddr(&mut self) -> HUBADDR_W<OTG_HS_HCSPLT9_SPEC, 7> {
        HUBADDR_W::new(self)
    }
    #[doc = "Bits 14:15 - XACTPOS"]
    #[inline(always)]
    #[must_use]
    pub fn xactpos(&mut self) -> XACTPOS_W<OTG_HS_HCSPLT9_SPEC, 14> {
        XACTPOS_W::new(self)
    }
    #[doc = "Bit 16 - Do complete split"]
    #[inline(always)]
    #[must_use]
    pub fn complsplt(&mut self) -> COMPLSPLT_W<OTG_HS_HCSPLT9_SPEC, 16> {
        COMPLSPLT_W::new(self)
    }
    #[doc = "Bit 31 - Split enable"]
    #[inline(always)]
    #[must_use]
    pub fn spliten(&mut self) -> SPLITEN_W<OTG_HS_HCSPLT9_SPEC, 31> {
        SPLITEN_W::new(self)
    }
