...
pub type R = crate::R<OTG_HS_HCTSIZ8_SPEC>;
#[doc = "Register `OTG_HS_HCTSIZ8` writer"]
pub type W = crate::W<OTG_HS_HCTSIZ8_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<OTG_HS_HCTSIZ8_SPEC, 0> {
        XFRSIZ_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<OTG_HS_HCTSIZ8_SPEC, 19> {
        PKTCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - Data PID"]
    #[inline(always)]
    #[must_use]
    pub fn dpid(&mut self) -> DPID_W<OTG_HS_HCTSIZ8_SPEC, 29> {
        DPID_W::new(self)
    }
