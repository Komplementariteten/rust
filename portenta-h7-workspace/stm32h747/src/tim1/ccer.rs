...
pub type CC5E_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC5P_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC6E_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC6P_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc5e(&mut self) -> CC5E_W<CCER_SPEC, 16> {
        CC5E_W::new(self)
    }
    #[doc = "Bit 17 - Capture/Compare 5 output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cc5p(&mut self) -> CC5P_W<CCER_SPEC, 17> {
        CC5P_W::new(self)
    }
    #[doc = "Bit 20 - Capture/Compare 6 output enable"]
    #[inline(always)]
    #[must_use]
    pub fn cc6e(&mut self) -> CC6E_W<CCER_SPEC, 20> {
        CC6E_W::new(self)
    }
    #[doc = "Bit 21 - Capture/Compare 6 output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cc6p(&mut self) -> CC6P_W<CCER_SPEC, 21> {
        CC6P_W::new(self)
    }
