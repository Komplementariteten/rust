...
pub type MMS2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ois5(&mut self) -> OIS5_W<CR2_SPEC, 16> {
        OIS5_W::new(self)
    }
    #[doc = "Bit 18 - Output Idle state 6"]
    #[inline(always)]
    #[must_use]
    pub fn ois6(&mut self) -> OIS6_W<CR2_SPEC, 18> {
        OIS6_W::new(self)
    }
    #[doc = "Bits 20:23 - Master mode selection 2"]
    #[inline(always)]
    #[must_use]
    pub fn mms2(&mut self) -> MMS2_W<CR2_SPEC, 20> {
        MMS2_W::new(self)
    }
