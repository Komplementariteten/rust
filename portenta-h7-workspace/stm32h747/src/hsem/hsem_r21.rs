...
pub type R = crate::R<HSEM_R21_SPEC>;
#[doc = "Register `HSEM_R21` writer"]
pub type W = crate::W<HSEM_R21_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn procid(&mut self) -> PROCID_W<HSEM_R21_SPEC, 0> {
        PROCID_W::new(self)
    }
    #[doc = "Bits 8:11 - Semaphore COREID"]
    #[inline(always)]
    #[must_use]
    pub fn coreid(&mut self) -> COREID_W<HSEM_R21_SPEC, 8> {
        COREID_W::new(self)
    }
    #[doc = "Bit 31 - Lock indication"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<HSEM_R21_SPEC, 31> {
        LOCK_W::new(self)
    }
