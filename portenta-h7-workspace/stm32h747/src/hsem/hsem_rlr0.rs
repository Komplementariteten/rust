...
pub type R = crate::R<HSEM_RLR0_SPEC>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hsem_rlr0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
