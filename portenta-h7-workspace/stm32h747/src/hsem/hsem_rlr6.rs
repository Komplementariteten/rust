...
pub type R = crate::R<HSEM_RLR6_SPEC>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hsem_rlr6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
