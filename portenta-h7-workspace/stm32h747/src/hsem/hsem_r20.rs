...
pub type R = crate::R<HSEM_R20_SPEC>;
#[doc = "Register `HSEM_R20` writer"]
pub type W = crate::W<HSEM_R20_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn procid(&mut self) -> PROCID_W<HSEM_R20_SPEC, 0> {
        PROCID_W::new(self)
    }
    #[doc = "Bits 8:11 - Semaphore COREID"]
    #[inline(always)]
    #[must_use]
    pub fn coreid(&mut self) -> COREID_W<HSEM_R20_SPEC, 8> {
        COREID_W::new(self)
    }
    #[doc = "Bit 31 - Lock indication"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<HSEM_R20_SPEC, 31> {
        LOCK_W::new(self)
    }
