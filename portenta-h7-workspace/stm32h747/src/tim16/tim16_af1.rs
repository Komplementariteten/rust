...
pub type R = crate::R<TIM16_AF1_SPEC>;
#[doc = "Register `TIM16_AF1` writer"]
pub type W = crate::W<TIM16_AF1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkine(&mut self) -> BKINE_W<TIM16_AF1_SPEC, 0> {
        BKINE_W::new(self)
    }
    #[doc = "Bit 1 - BRK COMP1 enable"]
    #[inline(always)]
    #[must_use]
    pub fn bkcmp1e(&mut self) -> BKCMP1E_W<TIM16_AF1_SPEC, 1> {
        BKCMP1E_W::new(self)
    }
    #[doc = "Bit 2 - BRK COMP2 enable"]
    #[inline(always)]
    #[must_use]
    pub fn bkcmp2e(&mut self) -> BKCMP2E_W<TIM16_AF1_SPEC, 2> {
        BKCMP2E_W::new(self)
    }
    #[doc = "Bit 8 - BRK dfsdm1_break\\[1\\]
enable"]
    #[inline(always)]
    #[must_use]
    pub fn bkdfbk1e(&mut self) -> BKDFBK1E_W<TIM16_AF1_SPEC, 8> {
        BKDFBK1E_W::new(self)
    }
    #[doc = "Bit 9 - BRK BKIN input polarity"]
    #[inline(always)]
    #[must_use]
    pub fn bkinp(&mut self) -> BKINP_W<TIM16_AF1_SPEC, 9> {
        BKINP_W::new(self)
    }
    #[doc = "Bit 10 - BRK COMP1 input polarity"]
    #[inline(always)]
    #[must_use]
    pub fn bkcmp1p(&mut self) -> BKCMP1P_W<TIM16_AF1_SPEC, 10> {
        BKCMP1P_W::new(self)
    }
    #[doc = "Bit 11 - BRK COMP2 input polarity"]
    #[inline(always)]
    #[must_use]
    pub fn bkcmp2p(&mut self) -> BKCMP2P_W<TIM16_AF1_SPEC, 11> {
        BKCMP2P_W::new(self)
    }
