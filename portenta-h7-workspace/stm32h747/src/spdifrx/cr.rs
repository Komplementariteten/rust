...
pub type SPDIFRXEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type CUMSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PTMSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CBDMAEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CHSEL` reader - Channel Selection"]
pub type CHSEL_R = crate::BitReader;
#[doc = "Field `CHSEL` writer - Channel Selection"]
pub type CHSEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CKSBKPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spdifrxen(&mut self) -> SPDIFRXEN_W<CR_SPEC, 0> {
        SPDIFRXEN_W::new(self)
    }
    #[doc = "Bit 2 - Receiver DMA ENable for data flow"]
    #[inline(always)]
    #[must_use]
    pub fn rxdmaen(&mut self) -> RXDMAEN_W<CR_SPEC, 2> {
        RXDMAEN_W::new(self)
    }
    #[doc = "Bit 3 - STerEO Mode"]
    #[inline(always)]
    #[must_use]
    pub fn rxsteo(&mut self) -> RXSTEO_W<CR_SPEC, 3> {
        RXSTEO_W::new(self)
    }
    #[doc = "Bits 4:5 - RX Data format"]
    #[inline(always)]
    #[must_use]
    pub fn drfmt(&mut self) -> DRFMT_W<CR_SPEC, 4> {
        DRFMT_W::new(self)
    }
    #[doc = "Bit 6 - Mask Parity error bit"]
    #[inline(always)]
    #[must_use]
    pub fn pmsk(&mut self) -> PMSK_W<CR_SPEC, 6> {
        PMSK_W::new(self)
    }
    #[doc = "Bit 7 - Mask of Validity bit"]
    #[inline(always)]
    #[must_use]
    pub fn vmsk(&mut self) -> VMSK_W<CR_SPEC, 7> {
        VMSK_W::new(self)
    }
    #[doc = "Bit 8 - Mask of channel status and user bits"]
    #[inline(always)]
    #[must_use]
    pub fn cumsk(&mut self) -> CUMSK_W<CR_SPEC, 8> {
        CUMSK_W::new(self)
    }
    #[doc = "Bit 9 - Mask of Preamble Type bits"]
    #[inline(always)]
    #[must_use]
    pub fn ptmsk(&mut self) -> PTMSK_W<CR_SPEC, 9> {
        PTMSK_W::new(self)
    }
    #[doc = "Bit 10 - Control Buffer DMA ENable for control flow"]
    #[inline(always)]
    #[must_use]
    pub fn cbdmaen(&mut self) -> CBDMAEN_W<CR_SPEC, 10> {
        CBDMAEN_W::new(self)
    }
    #[doc = "Bit 11 - Channel Selection"]
    #[inline(always)]
    #[must_use]
    pub fn chsel(&mut self) -> CHSEL_W<CR_SPEC, 11> {
        CHSEL_W::new(self)
    }
    #[doc = "Bits 12:13 - Maximum allowed re-tries during synchronization phase"]
    #[inline(always)]
    #[must_use]
    pub fn nbtr(&mut self) -> NBTR_W<CR_SPEC, 12> {
        NBTR_W::new(self)
    }
    #[doc = "Bit 14 - Wait For Activity"]
    #[inline(always)]
    #[must_use]
    pub fn wfa(&mut self) -> WFA_W<CR_SPEC, 14> {
        WFA_W::new(self)
    }
    #[doc = "Bits 16:18 - input selection"]
    #[inline(always)]
    #[must_use]
    pub fn insel(&mut self) -> INSEL_W<CR_SPEC, 16> {
        INSEL_W::new(self)
    }
    #[doc = "Bit 20 - Symbol Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cksen(&mut self) -> CKSEN_W<CR_SPEC, 20> {
        CKSEN_W::new(self)
    }
    #[doc = "Bit 21 - Backup Symbol Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cksbkpen(&mut self) -> CKSBKPEN_W<CR_SPEC, 21> {
        CKSBKPEN_W::new(self)
    }
