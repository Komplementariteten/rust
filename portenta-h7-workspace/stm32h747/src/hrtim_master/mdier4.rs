...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mcmp1ie(&mut self) -> MCMP1IE_W<MDIER4_SPEC, 0> {
        MCMP1IE_W::new(self)
    }
    #[doc = "Bit 1 - MCMP2IE"]
    #[inline(always)]
    #[must_use]
    pub fn mcmp2ie(&mut self) -> MCMP2IE_W<MDIER4_SPEC, 1> {
        MCMP2IE_W::new(self)
    }
    #[doc = "Bit 2 - MCMP3IE"]
    #[inline(always)]
    #[must_use]
    pub fn mcmp3ie(&mut self) -> MCMP3IE_W<MDIER4_SPEC, 2> {
        MCMP3IE_W::new(self)
    }
    #[doc = "Bit 3 - MCMP4IE"]
    #[inline(always)]
    #[must_use]
    pub fn mcmp4ie(&mut self) -> MCMP4IE_W<MDIER4_SPEC, 3> {
        MCMP4IE_W::new(self)
    }
    #[doc = "Bit 4 - MREPIE"]
    #[inline(always)]
    #[must_use]
    pub fn mrepie(&mut self) -> MREPIE_W<MDIER4_SPEC, 4> {
        MREPIE_W::new(self)
    }
    #[doc = "Bit 5 - SYNCIE"]
    #[inline(always)]
    #[must_use]
    pub fn syncie(&mut self) -> SYNCIE_W<MDIER4_SPEC, 5> {
        SYNCIE_W::new(self)
    }
    #[doc = "Bit 6 - MUPDIE"]
    #[inline(always)]
    #[must_use]
    pub fn mupdie(&mut self) -> MUPDIE_W<MDIER4_SPEC, 6> {
        MUPDIE_W::new(self)
    }
    #[doc = "Bit 16 - MCMP1DE"]
    #[inline(always)]
    #[must_use]
    pub fn mcmp1de(&mut self) -> MCMP1DE_W<MDIER4_SPEC, 16> {
        MCMP1DE_W::new(self)
    }
    #[doc = "Bit 17 - MCMP2DE"]
    #[inline(always)]
    #[must_use]
    pub fn mcmp2de(&mut self) -> MCMP2DE_W<MDIER4_SPEC, 17> {
        MCMP2DE_W::new(self)
    }
    #[doc = "Bit 18 - MCMP3DE"]
    #[inline(always)]
    #[must_use]
    pub fn mcmp3de(&mut self) -> MCMP3DE_W<MDIER4_SPEC, 18> {
        MCMP3DE_W::new(self)
    }
    #[doc = "Bit 19 - MCMP4DE"]
    #[inline(always)]
    #[must_use]
    pub fn mcmp4de(&mut self) -> MCMP4DE_W<MDIER4_SPEC, 19> {
        MCMP4DE_W::new(self)
    }
    #[doc = "Bit 20 - MREPDE"]
    #[inline(always)]
    #[must_use]
    pub fn mrepde(&mut self) -> MREPDE_W<MDIER4_SPEC, 20> {
        MREPDE_W::new(self)
    }
    #[doc = "Bit 21 - SYNCDE"]
    #[inline(always)]
    #[must_use]
    pub fn syncde(&mut self) -> SYNCDE_W<MDIER4_SPEC, 21> {
        SYNCDE_W::new(self)
    }
    #[doc = "Bit 22 - MUPDDE"]
    #[inline(always)]
    #[must_use]
    pub fn mupdde(&mut self) -> MUPDDE_W<MDIER4_SPEC, 22> {
        MUPDDE_W::new(self)
    }
