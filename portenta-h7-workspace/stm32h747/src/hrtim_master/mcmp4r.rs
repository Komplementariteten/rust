...
pub type R = crate::R<MCMP4R_SPEC>;
#[doc = "Register `MCMP4R` writer"]
pub type W = crate::W<MCMP4R_SPEC>;
...
pub type MCMP4_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mcmp4(&mut self) -> MCMP4_W<MCMP4R_SPEC, 0> {
        MCMP4_W::new(self)
    }
