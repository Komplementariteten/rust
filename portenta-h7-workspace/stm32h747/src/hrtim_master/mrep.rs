...
pub type R = crate::R<MREP_SPEC>;
#[doc = "Register `MREP` writer"]
pub type W = crate::W<MREP_SPEC>;
...
pub type MREP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mrep(&mut self) -> MREP_W<MREP_SPEC, 0> {
        MREP_W::new(self)
    }
