...
pub type R = crate::R<DFSDM_FLT2EXMIN_SPEC>;
...
#[doc = "Extremes detector minimum register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dfsdm_flt2exmin::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
