...
pub type R = crate::R<DFSDM_FLT3ICR_SPEC>;
#[doc = "Register `DFSDM_FLT3ICR` writer"]
pub type W = crate::W<DFSDM_FLT3ICR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrjovrf(&mut self) -> CLRJOVRF_W<DFSDM_FLT3ICR_SPEC, 2> {
        CLRJOVRF_W::new(self)
    }
    #[doc = "Bit 3 - Clear the regular conversion overrun flag"]
    #[inline(always)]
    #[must_use]
    pub fn clrrovrf(&mut self) -> CLRROVRF_W<DFSDM_FLT3ICR_SPEC, 3> {
        CLRROVRF_W::new(self)
    }
    #[doc = "Bits 16:23 - Clear the clock absence flag"]
    #[inline(always)]
    #[must_use]
    pub fn clrckabf(&mut self) -> CLRCKABF_W<DFSDM_FLT3ICR_SPEC, 16> {
        CLRCKABF_W::new(self)
    }
    #[doc = "Bits 24:31 - Clear the short-circuit detector flag"]
    #[inline(always)]
    #[must_use]
    pub fn clrscdf(&mut self) -> CLRSCDF_W<DFSDM_FLT3ICR_SPEC, 24> {
        CLRSCDF_W::new(self)
    }
