...
pub type R = crate::R<DFSDM_FLT1FCR_SPEC>;
#[doc = "Register `DFSDM_FLT1FCR` writer"]
pub type W = crate::W<DFSDM_FLT1FCR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iosr(&mut self) -> IOSR_W<DFSDM_FLT1FCR_SPEC, 0> {
        IOSR_W::new(self)
    }
    #[doc = "Bits 16:25 - Sinc filter oversampling ratio (decimation rate)"]
    #[inline(always)]
    #[must_use]
    pub fn fosr(&mut self) -> FOSR_W<DFSDM_FLT1FCR_SPEC, 16> {
        FOSR_W::new(self)
    }
    #[doc = "Bits 29:31 - Sinc filter order"]
    #[inline(always)]
    #[must_use]
    pub fn ford(&mut self) -> FORD_W<DFSDM_FLT1FCR_SPEC, 29> {
        FORD_W::new(self)
    }
