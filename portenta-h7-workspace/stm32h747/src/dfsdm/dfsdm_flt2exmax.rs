...
pub type R = crate::R<DFSDM_FLT2EXMAX_SPEC>;
...
#[doc = "Extremes detector maximum register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dfsdm_flt2exmax::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
