...
pub type R = crate::R<DFSDM_FLT2CR1_SPEC>;
#[doc = "Register `DFSDM_FLT2CR1` writer"]
pub type W = crate::W<DFSDM_FLT2CR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfen(&mut self) -> DFEN_W<DFSDM_FLT2CR1_SPEC, 0> {
        DFEN_W::new(self)
    }
    #[doc = "Bit 1 - Start a conversion of the injected group of channels"]
    #[inline(always)]
    #[must_use]
    pub fn jswstart(&mut self) -> JSWSTART_W<DFSDM_FLT2CR1_SPEC, 1> {
        JSWSTART_W::new(self)
    }
    #[doc = "Bit 3 - Launch an injected conversion synchronously with the DFSDM0 JSWSTART trigger"]
    #[inline(always)]
    #[must_use]
    pub fn jsync(&mut self) -> JSYNC_W<DFSDM_FLT2CR1_SPEC, 3> {
        JSYNC_W::new(self)
    }
    #[doc = "Bit 4 - Scanning conversion mode for injected conversions"]
    #[inline(always)]
    #[must_use]
    pub fn jscan(&mut self) -> JSCAN_W<DFSDM_FLT2CR1_SPEC, 4> {
        JSCAN_W::new(self)
    }
    #[doc = "Bit 5 - DMA channel enabled to read data for the injected channel group"]
    #[inline(always)]
    #[must_use]
    pub fn jdmaen(&mut self) -> JDMAEN_W<DFSDM_FLT2CR1_SPEC, 5> {
        JDMAEN_W::new(self)
    }
    #[doc = "Bits 8:10 - Trigger signal selection for launching injected conversions"]
    #[inline(always)]
    #[must_use]
    pub fn jextsel(&mut self) -> JEXTSEL_W<DFSDM_FLT2CR1_SPEC, 8> {
        JEXTSEL_W::new(self)
    }
    #[doc = "Bits 13:14 - Trigger enable and trigger edge selection for injected conversions"]
    #[inline(always)]
    #[must_use]
    pub fn jexten(&mut self) -> JEXTEN_W<DFSDM_FLT2CR1_SPEC, 13> {
        JEXTEN_W::new(self)
    }
    #[doc = "Bit 17 - Software start of a conversion on the regular channel"]
    #[inline(always)]
    #[must_use]
    pub fn rswstart(&mut self) -> RSWSTART_W<DFSDM_FLT2CR1_SPEC, 17> {
        RSWSTART_W::new(self)
    }
    #[doc = "Bit 18 - Continuous mode selection for regular conversions"]
    #[inline(always)]
    #[must_use]
    pub fn rcont(&mut self) -> RCONT_W<DFSDM_FLT2CR1_SPEC, 18> {
        RCONT_W::new(self)
    }
    #[doc = "Bit 19 - Launch regular conversion synchronously with DFSDM0"]
    #[inline(always)]
    #[must_use]
    pub fn rsync(&mut self) -> RSYNC_W<DFSDM_FLT2CR1_SPEC, 19> {
        RSYNC_W::new(self)
    }
    #[doc = "Bit 21 - DMA channel enabled to read data for the regular conversion"]
    #[inline(always)]
    #[must_use]
    pub fn rdmaen(&mut self) -> RDMAEN_W<DFSDM_FLT2CR1_SPEC, 21> {
        RDMAEN_W::new(self)
    }
    #[doc = "Bits 24:26 - Regular channel selection"]
    #[inline(always)]
    #[must_use]
    pub fn rch(&mut self) -> RCH_W<DFSDM_FLT2CR1_SPEC, 24> {
        RCH_W::new(self)
    }
    #[doc = "Bit 29 - Fast conversion mode selection for regular conversions"]
    #[inline(always)]
    #[must_use]
    pub fn fast(&mut self) -> FAST_W<DFSDM_FLT2CR1_SPEC, 29> {
        FAST_W::new(self)
    }
    #[doc = "Bit 30 - Analog watchdog fast mode select"]
    #[inline(always)]
    #[must_use]
    pub fn awfsel(&mut self) -> AWFSEL_W<DFSDM_FLT2CR1_SPEC, 30> {
        AWFSEL_W::new(self)
    }
