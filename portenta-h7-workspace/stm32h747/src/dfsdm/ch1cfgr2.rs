...
pub type R = crate::R<CH1CFGR2_SPEC>;
#[doc = "Register `CH1CFGR2` writer"]
pub type W = crate::W<CH1CFGR2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtrbs(&mut self) -> DTRBS_W<CH1CFGR2_SPEC, 3> {
        DTRBS_W::new(self)
    }
    #[doc = "Bits 8:31 - OFFSET"]
    #[inline(always)]
    #[must_use]
    pub fn offset(&mut self) -> OFFSET_W<CH1CFGR2_SPEC, 8> {
        OFFSET_W::new(self)
    }
