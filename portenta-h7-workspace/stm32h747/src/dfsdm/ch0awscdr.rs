...
pub type R = crate::R<CH0AWSCDR_SPEC>;
#[doc = "Register `CH0AWSCDR` writer"]
pub type W = crate::W<CH0AWSCDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scdt(&mut self) -> SCDT_W<CH0AWSCDR_SPEC, 0> {
        SCDT_W::new(self)
    }
    #[doc = "Bits 12:15 - BKSCD"]
    #[inline(always)]
    #[must_use]
    pub fn bkscd(&mut self) -> BKSCD_W<CH0AWSCDR_SPEC, 12> {
        BKSCD_W::new(self)
    }
    #[doc = "Bits 16:20 - AWFOSR"]
    #[inline(always)]
    #[must_use]
    pub fn awfosr(&mut self) -> AWFOSR_W<CH0AWSCDR_SPEC, 16> {
        AWFOSR_W::new(self)
    }
    #[doc = "Bits 22:23 - AWFORD"]
    #[inline(always)]
    #[must_use]
    pub fn awford(&mut self) -> AWFORD_W<CH0AWSCDR_SPEC, 22> {
        AWFORD_W::new(self)
    }
...
#[doc = "analog watchdog and short-circuit detector register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch0awscdr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch0awscdr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
