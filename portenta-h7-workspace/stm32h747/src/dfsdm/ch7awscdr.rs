...
pub type R = crate::R<CH7AWSCDR_SPEC>;
#[doc = "Register `CH7AWSCDR` writer"]
pub type W = crate::W<CH7AWSCDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scdt(&mut self) -> SCDT_W<CH7AWSCDR_SPEC, 0> {
        SCDT_W::new(self)
    }
    #[doc = "Bits 12:15 - BKSCD"]
    #[inline(always)]
    #[must_use]
    pub fn bkscd(&mut self) -> BKSCD_W<CH7AWSCDR_SPEC, 12> {
        BKSCD_W::new(self)
    }
    #[doc = "Bits 16:20 - AWFOSR"]
    #[inline(always)]
    #[must_use]
    pub fn awfosr(&mut self) -> AWFOSR_W<CH7AWSCDR_SPEC, 16> {
        AWFOSR_W::new(self)
    }
    #[doc = "Bits 22:23 - AWFORD"]
    #[inline(always)]
    #[must_use]
    pub fn awford(&mut self) -> AWFORD_W<CH7AWSCDR_SPEC, 22> {
        AWFORD_W::new(self)
    }
