...
pub type R = crate::R<DFSDM_FLT2AWCFR_SPEC>;
#[doc = "Register `DFSDM_FLT2AWCFR` writer"]
pub type W = crate::W<DFSDM_FLT2AWCFR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrawltf(&mut self) -> CLRAWLTF_W<DFSDM_FLT2AWCFR_SPEC, 0> {
        CLRAWLTF_W::new(self)
    }
    #[doc = "Bits 8:15 - Clear the analog watchdog high threshold flag"]
    #[inline(always)]
    #[must_use]
    pub fn clrawhtf(&mut self) -> CLRAWHTF_W<DFSDM_FLT2AWCFR_SPEC, 8> {
        CLRAWHTF_W::new(self)
    }
