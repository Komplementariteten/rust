...
pub type R = crate::R<DFSDM_FLT0ISR_SPEC>;
...
#[doc = "interrupt and status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dfsdm_flt0isr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
