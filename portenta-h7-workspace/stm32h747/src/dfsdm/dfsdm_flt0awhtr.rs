...
pub type R = crate::R<DFSDM_FLT0AWHTR_SPEC>;
#[doc = "Register `DFSDM_FLT0AWHTR` writer"]
pub type W = crate::W<DFSDM_FLT0AWHTR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkawh(&mut self) -> BKAWH_W<DFSDM_FLT0AWHTR_SPEC, 0> {
        BKAWH_W::new(self)
    }
    #[doc = "Bits 8:31 - Analog watchdog high threshold"]
    #[inline(always)]
    #[must_use]
    pub fn awht(&mut self) -> AWHT_W<DFSDM_FLT0AWHTR_SPEC, 8> {
        AWHT_W::new(self)
    }
