...
pub type R = crate::R<DFSDM_FLT3RDATAR_SPEC>;
...
#[doc = "data register for the regular channel\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dfsdm_flt3rdatar::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
