...
pub type R = crate::R<CH0DATINR_SPEC>;
#[doc = "Register `CH0DATINR` writer"]
pub type W = crate::W<CH0DATINR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn indat0(&mut self) -> INDAT0_W<CH0DATINR_SPEC, 0> {
        INDAT0_W::new(self)
    }
    #[doc = "Bits 16:31 - INDAT1"]
    #[inline(always)]
    #[must_use]
    pub fn indat1(&mut self) -> INDAT1_W<CH0DATINR_SPEC, 16> {
        INDAT1_W::new(self)
    }
