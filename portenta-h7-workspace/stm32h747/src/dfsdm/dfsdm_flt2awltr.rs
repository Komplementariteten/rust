...
pub type R = crate::R<DFSDM_FLT2AWLTR_SPEC>;
#[doc = "Register `DFSDM_FLT2AWLTR` writer"]
pub type W = crate::W<DFSDM_FLT2AWLTR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkawl(&mut self) -> BKAWL_W<DFSDM_FLT2AWLTR_SPEC, 0> {
        BKAWL_W::new(self)
    }
    #[doc = "Bits 8:31 - Analog watchdog low threshold"]
    #[inline(always)]
    #[must_use]
    pub fn awlt(&mut self) -> AWLT_W<DFSDM_FLT2AWLTR_SPEC, 8> {
        AWLT_W::new(self)
    }
