...
pub type R = crate::R<DFSDM_FLT1CR2_SPEC>;
#[doc = "Register `DFSDM_FLT1CR2` writer"]
pub type W = crate::W<DFSDM_FLT1CR2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn jeocie(&mut self) -> JEOCIE_W<DFSDM_FLT1CR2_SPEC, 0> {
        JEOCIE_W::new(self)
    }
    #[doc = "Bit 1 - Regular end of conversion interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn reocie(&mut self) -> REOCIE_W<DFSDM_FLT1CR2_SPEC, 1> {
        REOCIE_W::new(self)
    }
    #[doc = "Bit 2 - Injected data overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn jovrie(&mut self) -> JOVRIE_W<DFSDM_FLT1CR2_SPEC, 2> {
        JOVRIE_W::new(self)
    }
    #[doc = "Bit 3 - Regular data overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rovrie(&mut self) -> ROVRIE_W<DFSDM_FLT1CR2_SPEC, 3> {
        ROVRIE_W::new(self)
    }
    #[doc = "Bit 4 - Analog watchdog interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn awdie(&mut self) -> AWDIE_W<DFSDM_FLT1CR2_SPEC, 4> {
        AWDIE_W::new(self)
    }
    #[doc = "Bit 5 - Short-circuit detector interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn scdie(&mut self) -> SCDIE_W<DFSDM_FLT1CR2_SPEC, 5> {
        SCDIE_W::new(self)
    }
    #[doc = "Bit 6 - Clock absence interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ckabie(&mut self) -> CKABIE_W<DFSDM_FLT1CR2_SPEC, 6> {
        CKABIE_W::new(self)
    }
    #[doc = "Bits 8:15 - Extremes detector channel selection"]
    #[inline(always)]
    #[must_use]
    pub fn exch(&mut self) -> EXCH_W<DFSDM_FLT1CR2_SPEC, 8> {
        EXCH_W::new(self)
    }
    #[doc = "Bits 16:23 - Analog watchdog channel selection"]
    #[inline(always)]
    #[must_use]
    pub fn awdch(&mut self) -> AWDCH_W<DFSDM_FLT1CR2_SPEC, 16> {
        AWDCH_W::new(self)
    }
