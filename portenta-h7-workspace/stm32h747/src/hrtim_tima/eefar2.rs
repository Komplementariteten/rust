...
pub type R = crate::R<EEFAR2_SPEC>;
#[doc = "Register `EEFAR2` writer"]
pub type W = crate::W<EEFAR2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee6ltch(&mut self) -> EE6LTCH_W<EEFAR2_SPEC, 0> {
        EE6LTCH_W::new(self)
    }
    #[doc = "Bits 1:4 - External Event 6 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee6fltr(&mut self) -> EE6FLTR_W<EEFAR2_SPEC, 1> {
        EE6FLTR_W::new(self)
    }
    #[doc = "Bit 6 - External Event 7 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee7ltch(&mut self) -> EE7LTCH_W<EEFAR2_SPEC, 6> {
        EE7LTCH_W::new(self)
    }
    #[doc = "Bits 7:10 - External Event 7 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee7fltr(&mut self) -> EE7FLTR_W<EEFAR2_SPEC, 7> {
        EE7FLTR_W::new(self)
    }
    #[doc = "Bit 12 - External Event 8 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee8ltch(&mut self) -> EE8LTCH_W<EEFAR2_SPEC, 12> {
        EE8LTCH_W::new(self)
    }
    #[doc = "Bits 13:16 - External Event 8 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee8fltr(&mut self) -> EE8FLTR_W<EEFAR2_SPEC, 13> {
        EE8FLTR_W::new(self)
    }
    #[doc = "Bit 18 - External Event 9 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee9ltch(&mut self) -> EE9LTCH_W<EEFAR2_SPEC, 18> {
        EE9LTCH_W::new(self)
    }
    #[doc = "Bits 19:22 - External Event 9 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee9fltr(&mut self) -> EE9FLTR_W<EEFAR2_SPEC, 19> {
        EE9FLTR_W::new(self)
    }
    #[doc = "Bit 24 - External Event 10 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee10ltch(&mut self) -> EE10LTCH_W<EEFAR2_SPEC, 24> {
        EE10LTCH_W::new(self)
    }
    #[doc = "Bits 25:28 - External Event 10 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee10fltr(&mut self) -> EE10FLTR_W<EEFAR2_SPEC, 25> {
        EE10FLTR_W::new(self)
    }
