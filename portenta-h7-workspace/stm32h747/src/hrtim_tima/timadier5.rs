...
pub type R = crate::R<TIMADIER5_SPEC>;
#[doc = "Register `TIMADIER5` writer"]
pub type W = crate::W<TIMADIER5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1ie(&mut self) -> CMP1IE_W<TIMADIER5_SPEC, 0> {
        CMP1IE_W::new(self)
    }
    #[doc = "Bit 1 - CMP2IE"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2ie(&mut self) -> CMP2IE_W<TIMADIER5_SPEC, 1> {
        CMP2IE_W::new(self)
    }
    #[doc = "Bit 2 - CMP3IE"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3ie(&mut self) -> CMP3IE_W<TIMADIER5_SPEC, 2> {
        CMP3IE_W::new(self)
    }
    #[doc = "Bit 3 - CMP4IE"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4ie(&mut self) -> CMP4IE_W<TIMADIER5_SPEC, 3> {
        CMP4IE_W::new(self)
    }
    #[doc = "Bit 4 - REPIE"]
    #[inline(always)]
    #[must_use]
    pub fn repie(&mut self) -> REPIE_W<TIMADIER5_SPEC, 4> {
        REPIE_W::new(self)
    }
    #[doc = "Bit 6 - UPDIE"]
    #[inline(always)]
    #[must_use]
    pub fn updie(&mut self) -> UPDIE_W<TIMADIER5_SPEC, 6> {
        UPDIE_W::new(self)
    }
    #[doc = "Bit 7 - CPT1IE"]
    #[inline(always)]
    #[must_use]
    pub fn cpt1ie(&mut self) -> CPT1IE_W<TIMADIER5_SPEC, 7> {
        CPT1IE_W::new(self)
    }
    #[doc = "Bit 8 - CPT2IE"]
    #[inline(always)]
    #[must_use]
    pub fn cpt2ie(&mut self) -> CPT2IE_W<TIMADIER5_SPEC, 8> {
        CPT2IE_W::new(self)
    }
    #[doc = "Bit 9 - SET1xIE"]
    #[inline(always)]
    #[must_use]
    pub fn set1x_ie(&mut self) -> SET1X_IE_W<TIMADIER5_SPEC, 9> {
        SET1X_IE_W::new(self)
    }
    #[doc = "Bit 10 - RSTx1IE"]
    #[inline(always)]
    #[must_use]
    pub fn rstx1ie(&mut self) -> RSTX1IE_W<TIMADIER5_SPEC, 10> {
        RSTX1IE_W::new(self)
    }
    #[doc = "Bit 11 - SETx2IE"]
    #[inline(always)]
    #[must_use]
    pub fn setx2ie(&mut self) -> SETX2IE_W<TIMADIER5_SPEC, 11> {
        SETX2IE_W::new(self)
    }
    #[doc = "Bit 12 - RSTx2IE"]
    #[inline(always)]
    #[must_use]
    pub fn rstx2ie(&mut self) -> RSTX2IE_W<TIMADIER5_SPEC, 12> {
        RSTX2IE_W::new(self)
    }
    #[doc = "Bit 13 - RSTIE"]
    #[inline(always)]
    #[must_use]
    pub fn rstie(&mut self) -> RSTIE_W<TIMADIER5_SPEC, 13> {
        RSTIE_W::new(self)
    }
    #[doc = "Bit 14 - DLYPRTIE"]
    #[inline(always)]
    #[must_use]
    pub fn dlyprtie(&mut self) -> DLYPRTIE_W<TIMADIER5_SPEC, 14> {
        DLYPRTIE_W::new(self)
    }
    #[doc = "Bit 16 - CMP1DE"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1de(&mut self) -> CMP1DE_W<TIMADIER5_SPEC, 16> {
        CMP1DE_W::new(self)
    }
    #[doc = "Bit 17 - CMP2DE"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2de(&mut self) -> CMP2DE_W<TIMADIER5_SPEC, 17> {
        CMP2DE_W::new(self)
    }
    #[doc = "Bit 18 - CMP3DE"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3de(&mut self) -> CMP3DE_W<TIMADIER5_SPEC, 18> {
        CMP3DE_W::new(self)
    }
    #[doc = "Bit 19 - CMP4DE"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4de(&mut self) -> CMP4DE_W<TIMADIER5_SPEC, 19> {
        CMP4DE_W::new(self)
    }
    #[doc = "Bit 20 - REPDE"]
    #[inline(always)]
    #[must_use]
    pub fn repde(&mut self) -> REPDE_W<TIMADIER5_SPEC, 20> {
        REPDE_W::new(self)
    }
    #[doc = "Bit 22 - UPDDE"]
    #[inline(always)]
    #[must_use]
    pub fn updde(&mut self) -> UPDDE_W<TIMADIER5_SPEC, 22> {
        UPDDE_W::new(self)
    }
    #[doc = "Bit 23 - CPT1DE"]
    #[inline(always)]
    #[must_use]
    pub fn cpt1de(&mut self) -> CPT1DE_W<TIMADIER5_SPEC, 23> {
        CPT1DE_W::new(self)
    }
    #[doc = "Bit 24 - CPT2DE"]
    #[inline(always)]
    #[must_use]
    pub fn cpt2de(&mut self) -> CPT2DE_W<TIMADIER5_SPEC, 24> {
        CPT2DE_W::new(self)
    }
    #[doc = "Bit 25 - SET1xDE"]
    #[inline(always)]
    #[must_use]
    pub fn set1x_de(&mut self) -> SET1X_DE_W<TIMADIER5_SPEC, 25> {
        SET1X_DE_W::new(self)
    }
    #[doc = "Bit 26 - RSTx1DE"]
    #[inline(always)]
    #[must_use]
    pub fn rstx1de(&mut self) -> RSTX1DE_W<TIMADIER5_SPEC, 26> {
        RSTX1DE_W::new(self)
    }
    #[doc = "Bit 27 - SETx2DE"]
    #[inline(always)]
    #[must_use]
    pub fn setx2de(&mut self) -> SETX2DE_W<TIMADIER5_SPEC, 27> {
        SETX2DE_W::new(self)
    }
    #[doc = "Bit 28 - RSTx2DE"]
    #[inline(always)]
    #[must_use]
    pub fn rstx2de(&mut self) -> RSTX2DE_W<TIMADIER5_SPEC, 28> {
        RSTX2DE_W::new(self)
    }
    #[doc = "Bit 29 - RSTDE"]
    #[inline(always)]
    #[must_use]
    pub fn rstde(&mut self) -> RSTDE_W<TIMADIER5_SPEC, 29> {
        RSTDE_W::new(self)
    }
    #[doc = "Bit 30 - DLYPRTDE"]
    #[inline(always)]
    #[must_use]
    pub fn dlyprtde(&mut self) -> DLYPRTDE_W<TIMADIER5_SPEC, 30> {
        DLYPRTDE_W::new(self)
    }
...
#[doc = "TIMxDIER5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`timadier5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`timadier5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
