...
pub type R = crate::R<EEFAR1_SPEC>;
#[doc = "Register `EEFAR1` writer"]
pub type W = crate::W<EEFAR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee1ltch(&mut self) -> EE1LTCH_W<EEFAR1_SPEC, 0> {
        EE1LTCH_W::new(self)
    }
    #[doc = "Bits 1:4 - External Event 1 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee1fltr(&mut self) -> EE1FLTR_W<EEFAR1_SPEC, 1> {
        EE1FLTR_W::new(self)
    }
    #[doc = "Bit 6 - External Event 2 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee2ltch(&mut self) -> EE2LTCH_W<EEFAR1_SPEC, 6> {
        EE2LTCH_W::new(self)
    }
    #[doc = "Bits 7:10 - External Event 2 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee2fltr(&mut self) -> EE2FLTR_W<EEFAR1_SPEC, 7> {
        EE2FLTR_W::new(self)
    }
    #[doc = "Bit 12 - External Event 3 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee3ltch(&mut self) -> EE3LTCH_W<EEFAR1_SPEC, 12> {
        EE3LTCH_W::new(self)
    }
    #[doc = "Bits 13:16 - External Event 3 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee3fltr(&mut self) -> EE3FLTR_W<EEFAR1_SPEC, 13> {
        EE3FLTR_W::new(self)
    }
    #[doc = "Bit 18 - External Event 4 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee4ltch(&mut self) -> EE4LTCH_W<EEFAR1_SPEC, 18> {
        EE4LTCH_W::new(self)
    }
    #[doc = "Bits 19:22 - External Event 4 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee4fltr(&mut self) -> EE4FLTR_W<EEFAR1_SPEC, 19> {
        EE4FLTR_W::new(self)
    }
    #[doc = "Bit 24 - External Event 5 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee5ltch(&mut self) -> EE5LTCH_W<EEFAR1_SPEC, 24> {
        EE5LTCH_W::new(self)
    }
    #[doc = "Bits 25:28 - External Event 5 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee5fltr(&mut self) -> EE5FLTR_W<EEFAR1_SPEC, 25> {
        EE5FLTR_W::new(self)
    }
