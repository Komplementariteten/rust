...
pub type ICPCS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icpcs(&mut self) -> ICPCS_W<CCMR1_INPUT_SPEC, 2> {
        ICPCS_W::new(self)
    }
    #[doc = "Bits 4:7 - Input capture 1 filter"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ic2pcs(&mut self) -> IC2PCS_W<CCMR1_INPUT_SPEC, 10> {
        IC2PCS_W::new(self)
    }
    #[doc = "Bits 12:15 - Input capture 2 filter"]
    #[inline(always)]
