...
pub type R = crate::R<MDIOS_DOUTR1_SPEC>;
#[doc = "Register `MDIOS_DOUTR1` writer"]
pub type W = crate::W<MDIOS_DOUTR1_SPEC>;
...
pub type DOUT1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout1(&mut self) -> DOUT1_W<MDIOS_DOUTR1_SPEC, 0> {
        DOUT1_W::new(self)
    }
