...
pub type R = crate::R<MDIOS_DOUTR15_SPEC>;
#[doc = "Register `MDIOS_DOUTR15` writer"]
pub type W = crate::W<MDIOS_DOUTR15_SPEC>;
...
pub type DOUT15_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout15(&mut self) -> DOUT15_W<MDIOS_DOUTR15_SPEC, 0> {
        DOUT15_W::new(self)
    }
...
#[doc = "MDIOS output data register 15\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdios_doutr15::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdios_doutr15::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
