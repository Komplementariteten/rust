...
pub type R = crate::R<MDIOS_DOUTR11_SPEC>;
#[doc = "Register `MDIOS_DOUTR11` writer"]
pub type W = crate::W<MDIOS_DOUTR11_SPEC>;
...
pub type DOUT11_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout11(&mut self) -> DOUT11_W<MDIOS_DOUTR11_SPEC, 0> {
        DOUT11_W::new(self)
    }
