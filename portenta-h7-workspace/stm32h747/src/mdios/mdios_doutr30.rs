...
pub type R = crate::R<MDIOS_DOUTR30_SPEC>;
#[doc = "Register `MDIOS_DOUTR30` writer"]
pub type W = crate::W<MDIOS_DOUTR30_SPEC>;
...
pub type DOUT30_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout30(&mut self) -> DOUT30_W<MDIOS_DOUTR30_SPEC, 0> {
        DOUT30_W::new(self)
    }
...
#[doc = "MDIOS output data register 30\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdios_doutr30::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdios_doutr30::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
