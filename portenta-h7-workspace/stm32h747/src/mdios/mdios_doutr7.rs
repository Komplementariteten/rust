...
pub type R = crate::R<MDIOS_DOUTR7_SPEC>;
#[doc = "Register `MDIOS_DOUTR7` writer"]
pub type W = crate::W<MDIOS_DOUTR7_SPEC>;
...
pub type DOUT7_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout7(&mut self) -> DOUT7_W<MDIOS_DOUTR7_SPEC, 0> {
        DOUT7_W::new(self)
    }
...
#[doc = "MDIOS output data register 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdios_doutr7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdios_doutr7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
