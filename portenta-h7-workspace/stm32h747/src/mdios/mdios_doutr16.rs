...
pub type R = crate::R<MDIOS_DOUTR16_SPEC>;
#[doc = "Register `MDIOS_DOUTR16` writer"]
pub type W = crate::W<MDIOS_DOUTR16_SPEC>;
...
pub type DOUT16_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout16(&mut self) -> DOUT16_W<MDIOS_DOUTR16_SPEC, 0> {
        DOUT16_W::new(self)
    }
