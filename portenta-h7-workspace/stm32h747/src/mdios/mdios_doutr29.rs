...
pub type R = crate::R<MDIOS_DOUTR29_SPEC>;
#[doc = "Register `MDIOS_DOUTR29` writer"]
pub type W = crate::W<MDIOS_DOUTR29_SPEC>;
...
pub type DOUT29_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout29(&mut self) -> DOUT29_W<MDIOS_DOUTR29_SPEC, 0> {
        DOUT29_W::new(self)
    }
...
#[doc = "MDIOS output data register 29\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdios_doutr29::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdios_doutr29::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
