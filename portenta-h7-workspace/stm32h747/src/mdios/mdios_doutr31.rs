...
pub type R = crate::R<MDIOS_DOUTR31_SPEC>;
#[doc = "Register `MDIOS_DOUTR31` writer"]
pub type W = crate::W<MDIOS_DOUTR31_SPEC>;
...
pub type DOUT31_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout31(&mut self) -> DOUT31_W<MDIOS_DOUTR31_SPEC, 0> {
        DOUT31_W::new(self)
    }
