...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn camitfen(&mut self) -> CAMITFEN_W<AHB2ENR_SPEC, 0> {
        CAMITFEN_W::new(self)
    }
    #[doc = "Bit 4 - CRYPT peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn crypten(&mut self) -> CRYPTEN_W<AHB2ENR_SPEC, 4> {
        CRYPTEN_W::new(self)
    }
    #[doc = "Bit 5 - HASH peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn hashen(&mut self) -> HASHEN_W<AHB2ENR_SPEC, 5> {
        HASHEN_W::new(self)
    }
    #[doc = "Bit 6 - RNG peripheral clocks enable"]
    #[inline(always)]
    #[must_use]
    pub fn rngen(&mut self) -> RNGEN_W<AHB2ENR_SPEC, 6> {
        RNGEN_W::new(self)
    }
    #[doc = "Bit 9 - SDMMC2 and SDMMC2 delay clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2en(&mut self) -> SDMMC2EN_W<AHB2ENR_SPEC, 9> {
        SDMMC2EN_W::new(self)
    }
    #[doc = "Bit 29 - SRAM1 block enable"]
    #[inline(always)]
    #[must_use]
    pub fn sram1en(&mut self) -> SRAM1EN_W<AHB2ENR_SPEC, 29> {
        SRAM1EN_W::new(self)
    }
    #[doc = "Bit 30 - SRAM2 block enable"]
    #[inline(always)]
    #[must_use]
    pub fn sram2en(&mut self) -> SRAM2EN_W<AHB2ENR_SPEC, 30> {
        SRAM2EN_W::new(self)
    }
    #[doc = "Bit 31 - SRAM3 block enable"]
    #[inline(always)]
    #[must_use]
    pub fn sram3en(&mut self) -> SRAM3EN_W<AHB2ENR_SPEC, 31> {
        SRAM3EN_W::new(self)
    }
