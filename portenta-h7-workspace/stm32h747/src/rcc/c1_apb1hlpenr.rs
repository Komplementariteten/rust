...
pub type R = crate::R<C1_APB1HLPENR_SPEC>;
#[doc = "Register `C1_APB1HLPENR` writer"]
pub type W = crate::W<C1_APB1HLPENR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crslpen(&mut self) -> CRSLPEN_W<C1_APB1HLPENR_SPEC, 1> {
        CRSLPEN_W::new(self)
    }
    #[doc = "Bit 2 - SWPMI Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn swplpen(&mut self) -> SWPLPEN_W<C1_APB1HLPENR_SPEC, 2> {
        SWPLPEN_W::new(self)
    }
    #[doc = "Bit 4 - OPAMP peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn opamplpen(&mut self) -> OPAMPLPEN_W<C1_APB1HLPENR_SPEC, 4> {
        OPAMPLPEN_W::new(self)
    }
    #[doc = "Bit 5 - MDIOS peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn mdioslpen(&mut self) -> MDIOSLPEN_W<C1_APB1HLPENR_SPEC, 5> {
        MDIOSLPEN_W::new(self)
    }
    #[doc = "Bit 8 - FDCAN Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn fdcanlpen(&mut self) -> FDCANLPEN_W<C1_APB1HLPENR_SPEC, 8> {
