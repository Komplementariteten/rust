...
pub type R = crate::R<C1_AHB4ENR_SPEC>;
#[doc = "Register `C1_AHB4ENR` writer"]
pub type W = crate::W<C1_AHB4ENR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpioaen(&mut self) -> GPIOAEN_W<C1_AHB4ENR_SPEC, 0> {
        GPIOAEN_W::new(self)
    }
    #[doc = "Bit 1 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpioben(&mut self) -> GPIOBEN_W<C1_AHB4ENR_SPEC, 1> {
        GPIOBEN_W::new(self)
    }
    #[doc = "Bit 2 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpiocen(&mut self) -> GPIOCEN_W<C1_AHB4ENR_SPEC, 2> {
        GPIOCEN_W::new(self)
    }
    #[doc = "Bit 3 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpioden(&mut self) -> GPIODEN_W<C1_AHB4ENR_SPEC, 3> {
        GPIODEN_W::new(self)
    }
    #[doc = "Bit 4 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpioeen(&mut self) -> GPIOEEN_W<C1_AHB4ENR_SPEC, 4> {
        GPIOEEN_W::new(self)
    }
    #[doc = "Bit 5 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpiofen(&mut self) -> GPIOFEN_W<C1_AHB4ENR_SPEC, 5> {
        GPIOFEN_W::new(self)
    }
    #[doc = "Bit 6 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpiogen(&mut self) -> GPIOGEN_W<C1_AHB4ENR_SPEC, 6> {
        GPIOGEN_W::new(self)
    }
    #[doc = "Bit 7 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpiohen(&mut self) -> GPIOHEN_W<C1_AHB4ENR_SPEC, 7> {
        GPIOHEN_W::new(self)
    }
    #[doc = "Bit 8 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpioien(&mut self) -> GPIOIEN_W<C1_AHB4ENR_SPEC, 8> {
        GPIOIEN_W::new(self)
    }
    #[doc = "Bit 9 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpiojen(&mut self) -> GPIOJEN_W<C1_AHB4ENR_SPEC, 9> {
        GPIOJEN_W::new(self)
    }
    #[doc = "Bit 10 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpioken(&mut self) -> GPIOKEN_W<C1_AHB4ENR_SPEC, 10> {
        GPIOKEN_W::new(self)
    }
    #[doc = "Bit 19 - CRC peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn crcen(&mut self) -> CRCEN_W<C1_AHB4ENR_SPEC, 19> {
        CRCEN_W::new(self)
    }
    #[doc = "Bit 21 - BDMA and DMAMUX2 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bdmaen(&mut self) -> BDMAEN_W<C1_AHB4ENR_SPEC, 21> {
        BDMAEN_W::new(self)
    }
    #[doc = "Bit 24 - ADC3 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn adc3en(&mut self) -> ADC3EN_W<C1_AHB4ENR_SPEC, 24> {
        ADC3EN_W::new(self)
    }
    #[doc = "Bit 25 - HSEM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn hsemen(&mut self) -> HSEMEN_W<C1_AHB4ENR_SPEC, 25> {
        HSEMEN_W::new(self)
    }
    #[doc = "Bit 28 - Backup RAM Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bkpramen(&mut self) -> BKPRAMEN_W<C1_AHB4ENR_SPEC, 28> {
        BKPRAMEN_W::new(self)
    }
