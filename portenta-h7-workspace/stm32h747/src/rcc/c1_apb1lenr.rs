...
pub type R = crate::R<C1_APB1LENR_SPEC>;
#[doc = "Register `C1_APB1LENR` writer"]
pub type W = crate::W<C1_APB1LENR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim2en(&mut self) -> TIM2EN_W<C1_APB1LENR_SPEC, 0> {
        TIM2EN_W::new(self)
    }
    #[doc = "Bit 1 - TIM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim3en(&mut self) -> TIM3EN_W<C1_APB1LENR_SPEC, 1> {
        TIM3EN_W::new(self)
    }
    #[doc = "Bit 2 - TIM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim4en(&mut self) -> TIM4EN_W<C1_APB1LENR_SPEC, 2> {
        TIM4EN_W::new(self)
    }
    #[doc = "Bit 3 - TIM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim5en(&mut self) -> TIM5EN_W<C1_APB1LENR_SPEC, 3> {
        TIM5EN_W::new(self)
    }
    #[doc = "Bit 4 - TIM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim6en(&mut self) -> TIM6EN_W<C1_APB1LENR_SPEC, 4> {
        TIM6EN_W::new(self)
    }
    #[doc = "Bit 5 - TIM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim7en(&mut self) -> TIM7EN_W<C1_APB1LENR_SPEC, 5> {
        TIM7EN_W::new(self)
    }
    #[doc = "Bit 6 - TIM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim12en(&mut self) -> TIM12EN_W<C1_APB1LENR_SPEC, 6> {
        TIM12EN_W::new(self)
    }
    #[doc = "Bit 7 - TIM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim13en(&mut self) -> TIM13EN_W<C1_APB1LENR_SPEC, 7> {
        TIM13EN_W::new(self)
    }
    #[doc = "Bit 8 - TIM peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim14en(&mut self) -> TIM14EN_W<C1_APB1LENR_SPEC, 8> {
        TIM14EN_W::new(self)
    }
    #[doc = "Bit 9 - LPTIM1 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lptim1en(&mut self) -> LPTIM1EN_W<C1_APB1LENR_SPEC, 9> {
        LPTIM1EN_W::new(self)
    }
    #[doc = "Bit 14 - SPI2 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn spi2en(&mut self) -> SPI2EN_W<C1_APB1LENR_SPEC, 14> {
        SPI2EN_W::new(self)
    }
    #[doc = "Bit 15 - SPI3 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn spi3en(&mut self) -> SPI3EN_W<C1_APB1LENR_SPEC, 15> {
        SPI3EN_W::new(self)
    }
    #[doc = "Bit 16 - SPDIFRX Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn spdifrxen(&mut self) -> SPDIFRXEN_W<C1_APB1LENR_SPEC, 16> {
        SPDIFRXEN_W::new(self)
    }
    #[doc = "Bit 17 - USART2 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart2en(&mut self) -> USART2EN_W<C1_APB1LENR_SPEC, 17> {
        USART2EN_W::new(self)
    }
    #[doc = "Bit 18 - USART3 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart3en(&mut self) -> USART3EN_W<C1_APB1LENR_SPEC, 18> {
        USART3EN_W::new(self)
    }
    #[doc = "Bit 19 - UART4 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn uart4en(&mut self) -> UART4EN_W<C1_APB1LENR_SPEC, 19> {
        UART4EN_W::new(self)
    }
    #[doc = "Bit 20 - UART5 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn uart5en(&mut self) -> UART5EN_W<C1_APB1LENR_SPEC, 20> {
        UART5EN_W::new(self)
    }
    #[doc = "Bit 21 - I2C1 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c1en(&mut self) -> I2C1EN_W<C1_APB1LENR_SPEC, 21> {
        I2C1EN_W::new(self)
    }
    #[doc = "Bit 22 - I2C2 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c2en(&mut self) -> I2C2EN_W<C1_APB1LENR_SPEC, 22> {
        I2C2EN_W::new(self)
    }
    #[doc = "Bit 23 - I2C3 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c3en(&mut self) -> I2C3EN_W<C1_APB1LENR_SPEC, 23> {
        I2C3EN_W::new(self)
    }
    #[doc = "Bit 27 - HDMI-CEC peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn hdmicecen(&mut self) -> HDMICECEN_W<C1_APB1LENR_SPEC, 27> {
        HDMICECEN_W::new(self)
    }
    #[doc = "Bit 29 - DAC1&amp;2 peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn dac12en(&mut self) -> DAC12EN_W<C1_APB1LENR_SPEC, 29> {
        DAC12EN_W::new(self)
    }
    #[doc = "Bit 30 - USART7 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart7en(&mut self) -> USART7EN_W<C1_APB1LENR_SPEC, 30> {
        USART7EN_W::new(self)
    }
    #[doc = "Bit 31 - USART8 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart8en(&mut self) -> USART8EN_W<C1_APB1LENR_SPEC, 31> {
        USART8EN_W::new(self)
    }
