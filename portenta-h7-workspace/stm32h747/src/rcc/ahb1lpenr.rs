...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma1lpen(&mut self) -> DMA1LPEN_W<AHB1LPENR_SPEC, 0> {
        DMA1LPEN_W::new(self)
    }
    #[doc = "Bit 1 - DMA2 Clock Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn dma2lpen(&mut self) -> DMA2LPEN_W<AHB1LPENR_SPEC, 1> {
        DMA2LPEN_W::new(self)
    }
    #[doc = "Bit 5 - ADC1/2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn adc12lpen(&mut self) -> ADC12LPEN_W<AHB1LPENR_SPEC, 5> {
        ADC12LPEN_W::new(self)
    }
    #[doc = "Bit 15 - Ethernet MAC bus interface Clock Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eth1maclpen(&mut self) -> ETH1MACLPEN_W<AHB1LPENR_SPEC, 15> {
        ETH1MACLPEN_W::new(self)
    }
    #[doc = "Bit 16 - Ethernet Transmission Clock Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eth1txlpen(&mut self) -> ETH1TXLPEN_W<AHB1LPENR_SPEC, 16> {
        ETH1TXLPEN_W::new(self)
    }
    #[doc = "Bit 17 - Ethernet Reception Clock Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eth1rxlpen(&mut self) -> ETH1RXLPEN_W<AHB1LPENR_SPEC, 17> {
        ETH1RXLPEN_W::new(self)
    }
    #[doc = "Bit 25 - USB1OTG peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn usb1otglpen(&mut self) -> USB1OTGLPEN_W<AHB1LPENR_SPEC, 25> {
        USB1OTGLPEN_W::new(self)
    }
    #[doc = "Bit 26 - USB_PHY1 clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn usb1ulpilpen(&mut self) -> USB1ULPILPEN_W<AHB1LPENR_SPEC, 26> {
        USB1ULPILPEN_W::new(self)
    }
    #[doc = "Bit 27 - USB2OTG peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn usb2otglpen(&mut self) -> USB2OTGLPEN_W<AHB1LPENR_SPEC, 27> {
        USB2OTGLPEN_W::new(self)
    }
    #[doc = "Bit 28 - USB_PHY2 clocks enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn usb2ulpilpen(&mut self) -> USB2ULPILPEN_W<AHB1LPENR_SPEC, 28> {
