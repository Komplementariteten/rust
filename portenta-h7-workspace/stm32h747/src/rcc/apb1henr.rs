...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crsen(&mut self) -> CRSEN_W<APB1HENR_SPEC, 1> {
        CRSEN_W::new(self)
    }
    #[doc = "Bit 2 - SWPMI Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn swpen(&mut self) -> SWPEN_W<APB1HENR_SPEC, 2> {
        SWPEN_W::new(self)
    }
    #[doc = "Bit 4 - OPAMP peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn opampen(&mut self) -> OPAMPEN_W<APB1HENR_SPEC, 4> {
        OPAMPEN_W::new(self)
    }
    #[doc = "Bit 5 - MDIOS peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn mdiosen(&mut self) -> MDIOSEN_W<APB1HENR_SPEC, 5> {
        MDIOSEN_W::new(self)
    }
    #[doc = "Bit 8 - FDCAN Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn fdcanen(&mut self) -> FDCANEN_W<APB1HENR_SPEC, 8> {
        FDCANEN_W::new(self)
    }
