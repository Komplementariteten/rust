...
pub type R = crate::R<C1_APB3ENR_SPEC>;
#[doc = "Register `C1_APB3ENR` writer"]
pub type W = crate::W<C1_APB3ENR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ltdcen(&mut self) -> LTDCEN_W<C1_APB3ENR_SPEC, 3> {
        LTDCEN_W::new(self)
    }
    #[doc = "Bit 6 - WWDG1 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wwdg1en(&mut self) -> WWDG1EN_W<C1_APB3ENR_SPEC, 6> {
        WWDG1EN_W::new(self)
    }
