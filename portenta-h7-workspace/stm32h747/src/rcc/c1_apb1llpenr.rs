...
pub type R = crate::R<C1_APB1LLPENR_SPEC>;
#[doc = "Register `C1_APB1LLPENR` writer"]
pub type W = crate::W<C1_APB1LLPENR_SPEC>;
...
pub type LPTIM1LPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPDIFRXLPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DAC12LPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim2lpen(&mut self) -> TIM2LPEN_W<C1_APB1LLPENR_SPEC, 0> {
        TIM2LPEN_W::new(self)
    }
    #[doc = "Bit 1 - TIM3 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn tim3lpen(&mut self) -> TIM3LPEN_W<C1_APB1LLPENR_SPEC, 1> {
        TIM3LPEN_W::new(self)
    }
    #[doc = "Bit 2 - TIM4 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn tim4lpen(&mut self) -> TIM4LPEN_W<C1_APB1LLPENR_SPEC, 2> {
        TIM4LPEN_W::new(self)
    }
    #[doc = "Bit 3 - TIM5 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn tim5lpen(&mut self) -> TIM5LPEN_W<C1_APB1LLPENR_SPEC, 3> {
        TIM5LPEN_W::new(self)
    }
    #[doc = "Bit 4 - TIM6 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn tim6lpen(&mut self) -> TIM6LPEN_W<C1_APB1LLPENR_SPEC, 4> {
        TIM6LPEN_W::new(self)
    }
    #[doc = "Bit 5 - TIM7 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn tim7lpen(&mut self) -> TIM7LPEN_W<C1_APB1LLPENR_SPEC, 5> {
        TIM7LPEN_W::new(self)
    }
    #[doc = "Bit 6 - TIM12 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn tim12lpen(&mut self) -> TIM12LPEN_W<C1_APB1LLPENR_SPEC, 6> {
        TIM12LPEN_W::new(self)
    }
    #[doc = "Bit 7 - TIM13 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn tim13lpen(&mut self) -> TIM13LPEN_W<C1_APB1LLPENR_SPEC, 7> {
        TIM13LPEN_W::new(self)
    }
    #[doc = "Bit 8 - TIM14 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn tim14lpen(&mut self) -> TIM14LPEN_W<C1_APB1LLPENR_SPEC, 8> {
        TIM14LPEN_W::new(self)
    }
    #[doc = "Bit 9 - LPTIM1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn lptim1lpen(&mut self) -> LPTIM1LPEN_W<C1_APB1LLPENR_SPEC, 9> {
        LPTIM1LPEN_W::new(self)
    }
    #[doc = "Bit 14 - SPI2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn spi2lpen(&mut self) -> SPI2LPEN_W<C1_APB1LLPENR_SPEC, 14> {
        SPI2LPEN_W::new(self)
    }
    #[doc = "Bit 15 - SPI3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn spi3lpen(&mut self) -> SPI3LPEN_W<C1_APB1LLPENR_SPEC, 15> {
        SPI3LPEN_W::new(self)
    }
    #[doc = "Bit 16 - SPDIFRX Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn spdifrxlpen(&mut self) -> SPDIFRXLPEN_W<C1_APB1LLPENR_SPEC, 16> {
        SPDIFRXLPEN_W::new(self)
    }
    #[doc = "Bit 17 - USART2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn usart2lpen(&mut self) -> USART2LPEN_W<C1_APB1LLPENR_SPEC, 17> {
        USART2LPEN_W::new(self)
    }
    #[doc = "Bit 18 - USART3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn usart3lpen(&mut self) -> USART3LPEN_W<C1_APB1LLPENR_SPEC, 18> {
        USART3LPEN_W::new(self)
    }
    #[doc = "Bit 19 - UART4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn uart4lpen(&mut self) -> UART4LPEN_W<C1_APB1LLPENR_SPEC, 19> {
        UART4LPEN_W::new(self)
    }
    #[doc = "Bit 20 - UART5 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn uart5lpen(&mut self) -> UART5LPEN_W<C1_APB1LLPENR_SPEC, 20> {
        UART5LPEN_W::new(self)
    }
    #[doc = "Bit 21 - I2C1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn i2c1lpen(&mut self) -> I2C1LPEN_W<C1_APB1LLPENR_SPEC, 21> {
        I2C1LPEN_W::new(self)
    }
    #[doc = "Bit 22 - I2C2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn i2c2lpen(&mut self) -> I2C2LPEN_W<C1_APB1LLPENR_SPEC, 22> {
        I2C2LPEN_W::new(self)
    }
    #[doc = "Bit 23 - I2C3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn i2c3lpen(&mut self) -> I2C3LPEN_W<C1_APB1LLPENR_SPEC, 23> {
        I2C3LPEN_W::new(self)
    }
    #[doc = "Bit 27 - HDMI-CEC Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn hdmiceclpen(&mut self) -> HDMICECLPEN_W<C1_APB1LLPENR_SPEC, 27> {
        HDMICECLPEN_W::new(self)
    }
    #[doc = "Bit 29 - DAC1/2 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn dac12lpen(&mut self) -> DAC12LPEN_W<C1_APB1LLPENR_SPEC, 29> {
        DAC12LPEN_W::new(self)
    }
    #[doc = "Bit 30 - USART7 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn usart7lpen(&mut self) -> USART7LPEN_W<C1_APB1LLPENR_SPEC, 30> {
        USART7LPEN_W::new(self)
    }
    #[doc = "Bit 31 - USART8 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn usart8lpen(&mut self) -> USART8LPEN_W<C1_APB1LLPENR_SPEC, 31> {
