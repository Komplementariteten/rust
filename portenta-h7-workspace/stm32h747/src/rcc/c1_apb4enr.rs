...
pub type R = crate::R<C1_APB4ENR_SPEC>;
#[doc = "Register `C1_APB4ENR` writer"]
pub type W = crate::W<C1_APB4ENR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn syscfgen(&mut self) -> SYSCFGEN_W<C1_APB4ENR_SPEC, 1> {
        SYSCFGEN_W::new(self)
    }
    #[doc = "Bit 3 - LPUART1 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lpuart1en(&mut self) -> LPUART1EN_W<C1_APB4ENR_SPEC, 3> {
        LPUART1EN_W::new(self)
    }
    #[doc = "Bit 5 - SPI6 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn spi6en(&mut self) -> SPI6EN_W<C1_APB4ENR_SPEC, 5> {
        SPI6EN_W::new(self)
    }
    #[doc = "Bit 7 - I2C4 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c4en(&mut self) -> I2C4EN_W<C1_APB4ENR_SPEC, 7> {
        I2C4EN_W::new(self)
    }
    #[doc = "Bit 9 - LPTIM2 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lptim2en(&mut self) -> LPTIM2EN_W<C1_APB4ENR_SPEC, 9> {
        LPTIM2EN_W::new(self)
    }
    #[doc = "Bit 10 - LPTIM3 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lptim3en(&mut self) -> LPTIM3EN_W<C1_APB4ENR_SPEC, 10> {
        LPTIM3EN_W::new(self)
    }
    #[doc = "Bit 11 - LPTIM4 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lptim4en(&mut self) -> LPTIM4EN_W<C1_APB4ENR_SPEC, 11> {
        LPTIM4EN_W::new(self)
    }
    #[doc = "Bit 12 - LPTIM5 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lptim5en(&mut self) -> LPTIM5EN_W<C1_APB4ENR_SPEC, 12> {
        LPTIM5EN_W::new(self)
    }
    #[doc = "Bit 14 - COMP1/2 peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn comp12en(&mut self) -> COMP12EN_W<C1_APB4ENR_SPEC, 14> {
        COMP12EN_W::new(self)
    }
    #[doc = "Bit 15 - VREF peripheral clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn vrefen(&mut self) -> VREFEN_W<C1_APB4ENR_SPEC, 15> {
        VREFEN_W::new(self)
    }
    #[doc = "Bit 16 - RTC APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rtcapben(&mut self) -> RTCAPBEN_W<C1_APB4ENR_SPEC, 16> {
        RTCAPBEN_W::new(self)
    }
    #[doc = "Bit 21 - SAI4 Peripheral Clocks Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sai4en(&mut self) -> SAI4EN_W<C1_APB4ENR_SPEC, 21> {
        SAI4EN_W::new(self)
    }
