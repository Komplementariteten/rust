...
pub type R = crate::R<C1_APB4LPENR_SPEC>;
#[doc = "Register `C1_APB4LPENR` writer"]
pub type W = crate::W<C1_APB4LPENR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn syscfglpen(&mut self) -> SYSCFGLPEN_W<C1_APB4LPENR_SPEC, 1> {
        SYSCFGLPEN_W::new(self)
    }
    #[doc = "Bit 3 - LPUART1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn lpuart1lpen(&mut self) -> LPUART1LPEN_W<C1_APB4LPENR_SPEC, 3> {
        LPUART1LPEN_W::new(self)
    }
    #[doc = "Bit 5 - SPI6 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn spi6lpen(&mut self) -> SPI6LPEN_W<C1_APB4LPENR_SPEC, 5> {
        SPI6LPEN_W::new(self)
    }
    #[doc = "Bit 7 - I2C4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn i2c4lpen(&mut self) -> I2C4LPEN_W<C1_APB4LPENR_SPEC, 7> {
        I2C4LPEN_W::new(self)
    }
    #[doc = "Bit 9 - LPTIM2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn lptim2lpen(&mut self) -> LPTIM2LPEN_W<C1_APB4LPENR_SPEC, 9> {
        LPTIM2LPEN_W::new(self)
    }
    #[doc = "Bit 10 - LPTIM3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn lptim3lpen(&mut self) -> LPTIM3LPEN_W<C1_APB4LPENR_SPEC, 10> {
        LPTIM3LPEN_W::new(self)
    }
    #[doc = "Bit 11 - LPTIM4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn lptim4lpen(&mut self) -> LPTIM4LPEN_W<C1_APB4LPENR_SPEC, 11> {
        LPTIM4LPEN_W::new(self)
    }
    #[doc = "Bit 12 - LPTIM5 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn lptim5lpen(&mut self) -> LPTIM5LPEN_W<C1_APB4LPENR_SPEC, 12> {
        LPTIM5LPEN_W::new(self)
    }
    #[doc = "Bit 14 - COMP1/2 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn comp12lpen(&mut self) -> COMP12LPEN_W<C1_APB4LPENR_SPEC, 14> {
        COMP12LPEN_W::new(self)
    }
    #[doc = "Bit 15 - VREF peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn vreflpen(&mut self) -> VREFLPEN_W<C1_APB4LPENR_SPEC, 15> {
        VREFLPEN_W::new(self)
    }
    #[doc = "Bit 16 - RTC APB Clock Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn rtcapblpen(&mut self) -> RTCAPBLPEN_W<C1_APB4LPENR_SPEC, 16> {
        RTCAPBLPEN_W::new(self)
    }
    #[doc = "Bit 21 - SAI4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    #[must_use]
    pub fn sai4lpen(&mut self) -> SAI4LPEN_W<C1_APB4LPENR_SPEC, 21> {
        SAI4LPEN_W::new(self)
    }
