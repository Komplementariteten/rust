...
pub type R = crate::R<MACIVIR_SPEC>;
#[doc = "Register `MACIVIR` writer"]
pub type W = crate::W<MACIVIR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vlt(&mut self) -> VLT_W<MACIVIR_SPEC, 0> {
        VLT_W::new(self)
    }
    #[doc = "Bits 16:17 - VLC"]
    #[inline(always)]
    #[must_use]
    pub fn vlc(&mut self) -> VLC_W<MACIVIR_SPEC, 16> {
        VLC_W::new(self)
    }
    #[doc = "Bit 18 - VLP"]
    #[inline(always)]
    #[must_use]
    pub fn vlp(&mut self) -> VLP_W<MACIVIR_SPEC, 18> {
        VLP_W::new(self)
    }
    #[doc = "Bit 19 - CSVL"]
    #[inline(always)]
    #[must_use]
    pub fn csvl(&mut self) -> CSVL_W<MACIVIR_SPEC, 19> {
        CSVL_W::new(self)
    }
    #[doc = "Bit 20 - VLTI"]
    #[inline(always)]
    #[must_use]
    pub fn vlti(&mut self) -> VLTI_W<MACIVIR_SPEC, 20> {
        VLTI_W::new(self)
    }
