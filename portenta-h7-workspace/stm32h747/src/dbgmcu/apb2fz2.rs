...
pub type R = crate::R<APB2FZ2_SPEC>;
#[doc = "Register `APB2FZ2` writer"]
pub type W = crate::W<APB2FZ2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim1(&mut self) -> DBG_TIM1_W<APB2FZ2_SPEC, 0> {
        DBG_TIM1_W::new(self)
    }
    #[doc = "Bit 1 - TIM8 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim8(&mut self) -> DBG_TIM8_W<APB2FZ2_SPEC, 1> {
        DBG_TIM8_W::new(self)
    }
    #[doc = "Bit 16 - TIM15 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim15(&mut self) -> DBG_TIM15_W<APB2FZ2_SPEC, 16> {
        DBG_TIM15_W::new(self)
    }
    #[doc = "Bit 17 - TIM16 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim16(&mut self) -> DBG_TIM16_W<APB2FZ2_SPEC, 17> {
        DBG_TIM16_W::new(self)
    }
    #[doc = "Bit 18 - TIM17 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim17(&mut self) -> DBG_TIM17_W<APB2FZ2_SPEC, 18> {
        DBG_TIM17_W::new(self)
    }
    #[doc = "Bit 29 - HRTIM stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_hrtim(&mut self) -> DBG_HRTIM_W<APB2FZ2_SPEC, 29> {
