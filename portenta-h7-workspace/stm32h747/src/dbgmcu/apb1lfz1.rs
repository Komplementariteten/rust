...
pub type R = crate::R<APB1LFZ1_SPEC>;
#[doc = "Register `APB1LFZ1` writer"]
pub type W = crate::W<APB1LFZ1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim2(&mut self) -> DBG_TIM2_W<APB1LFZ1_SPEC, 0> {
        DBG_TIM2_W::new(self)
    }
    #[doc = "Bit 1 - TIM3 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim3(&mut self) -> DBG_TIM3_W<APB1LFZ1_SPEC, 1> {
        DBG_TIM3_W::new(self)
    }
    #[doc = "Bit 2 - TIM4 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim4(&mut self) -> DBG_TIM4_W<APB1LFZ1_SPEC, 2> {
        DBG_TIM4_W::new(self)
    }
    #[doc = "Bit 3 - TIM5 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim5(&mut self) -> DBG_TIM5_W<APB1LFZ1_SPEC, 3> {
        DBG_TIM5_W::new(self)
    }
    #[doc = "Bit 4 - TIM6 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim6(&mut self) -> DBG_TIM6_W<APB1LFZ1_SPEC, 4> {
        DBG_TIM6_W::new(self)
    }
    #[doc = "Bit 5 - TIM7 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim7(&mut self) -> DBG_TIM7_W<APB1LFZ1_SPEC, 5> {
        DBG_TIM7_W::new(self)
    }
    #[doc = "Bit 6 - TIM12 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim12(&mut self) -> DBG_TIM12_W<APB1LFZ1_SPEC, 6> {
        DBG_TIM12_W::new(self)
    }
    #[doc = "Bit 7 - TIM13 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim13(&mut self) -> DBG_TIM13_W<APB1LFZ1_SPEC, 7> {
        DBG_TIM13_W::new(self)
    }
    #[doc = "Bit 8 - TIM14 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim14(&mut self) -> DBG_TIM14_W<APB1LFZ1_SPEC, 8> {
        DBG_TIM14_W::new(self)
    }
    #[doc = "Bit 9 - LPTIM1 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_lptim1(&mut self) -> DBG_LPTIM1_W<APB1LFZ1_SPEC, 9> {
        DBG_LPTIM1_W::new(self)
    }
    #[doc = "Bit 11 - WWDG2 stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_wwdg2(&mut self) -> DBG_WWDG2_W<APB1LFZ1_SPEC, 11> {
        DBG_WWDG2_W::new(self)
    }
    #[doc = "Bit 21 - I2C1 SMBUS timeout stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_i2c1(&mut self) -> DBG_I2C1_W<APB1LFZ1_SPEC, 21> {
        DBG_I2C1_W::new(self)
    }
    #[doc = "Bit 22 - I2C2 SMBUS timeout stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_i2c2(&mut self) -> DBG_I2C2_W<APB1LFZ1_SPEC, 22> {
        DBG_I2C2_W::new(self)
    }
    #[doc = "Bit 23 - I2C3 SMBUS timeout stop in debug"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_i2c3(&mut self) -> DBG_I2C3_W<APB1LFZ1_SPEC, 23> {
        DBG_I2C3_W::new(self)
    }
