...
pub type R = crate::R<OTG_HS_GINTSTS_SPEC>;
#[doc = "Register `OTG_HS_GINTSTS` writer"]
pub type W = crate::W<OTG_HS_GINTSTS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mmis(&mut self) -> MMIS_W<OTG_HS_GINTSTS_SPEC, 1> {
        MMIS_W::new(self)
    }
    #[doc = "Bit 3 - Start of frame"]
    #[inline(always)]
    #[must_use]
    pub fn sof(&mut self) -> SOF_W<OTG_HS_GINTSTS_SPEC, 3> {
        SOF_W::new(self)
    }
    #[doc = "Bit 10 - Early suspend"]
    #[inline(always)]
    #[must_use]
    pub fn esusp(&mut self) -> ESUSP_W<OTG_HS_GINTSTS_SPEC, 10> {
        ESUSP_W::new(self)
    }
    #[doc = "Bit 11 - USB suspend"]
    #[inline(always)]
    #[must_use]
    pub fn usbsusp(&mut self) -> USBSUSP_W<OTG_HS_GINTSTS_SPEC, 11> {
        USBSUSP_W::new(self)
    }
    #[doc = "Bit 12 - USB reset"]
    #[inline(always)]
    #[must_use]
    pub fn usbrst(&mut self) -> USBRST_W<OTG_HS_GINTSTS_SPEC, 12> {
        USBRST_W::new(self)
    }
    #[doc = "Bit 13 - Enumeration done"]
    #[inline(always)]
    #[must_use]
    pub fn enumdne(&mut self) -> ENUMDNE_W<OTG_HS_GINTSTS_SPEC, 13> {
        ENUMDNE_W::new(self)
    }
    #[doc = "Bit 14 - Isochronous OUT packet dropped interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn isoodrp(&mut self) -> ISOODRP_W<OTG_HS_GINTSTS_SPEC, 14> {
        ISOODRP_W::new(self)
    }
    #[doc = "Bit 15 - End of periodic frame interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eopf(&mut self) -> EOPF_W<OTG_HS_GINTSTS_SPEC, 15> {
        EOPF_W::new(self)
    }
    #[doc = "Bit 20 - Incomplete isochronous IN transfer"]
    #[inline(always)]
    #[must_use]
    pub fn iisoixfr(&mut self) -> IISOIXFR_W<OTG_HS_GINTSTS_SPEC, 20> {
        IISOIXFR_W::new(self)
    }
    #[doc = "Bit 21 - Incomplete periodic transfer"]
    #[inline(always)]
    #[must_use]
    pub fn pxfr_incompisoout(&mut self) -> PXFR_INCOMPISOOUT_W<OTG_HS_GINTSTS_SPEC, 21> {
        PXFR_INCOMPISOOUT_W::new(self)
    }
    #[doc = "Bit 22 - Data fetch suspended"]
    #[inline(always)]
    #[must_use]
    pub fn datafsusp(&mut self) -> DATAFSUSP_W<OTG_HS_GINTSTS_SPEC, 22> {
        DATAFSUSP_W::new(self)
    }
    #[doc = "Bit 28 - Connector ID status change"]
    #[inline(always)]
    #[must_use]
    pub fn cidschg(&mut self) -> CIDSCHG_W<OTG_HS_GINTSTS_SPEC, 28> {
        CIDSCHG_W::new(self)
    }
    #[doc = "Bit 29 - Disconnect detected interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn discint(&mut self) -> DISCINT_W<OTG_HS_GINTSTS_SPEC, 29> {
        DISCINT_W::new(self)
    }
    #[doc = "Bit 30 - Session request/new session detected interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn srqint(&mut self) -> SRQINT_W<OTG_HS_GINTSTS_SPEC, 30> {
        SRQINT_W::new(self)
    }
    #[doc = "Bit 31 - Resume/remote wakeup detected interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn wkuint(&mut self) -> WKUINT_W<OTG_HS_GINTSTS_SPEC, 31> {
        WKUINT_W::new(self)
    }
