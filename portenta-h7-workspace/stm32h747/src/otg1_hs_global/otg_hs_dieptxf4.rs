...
pub type R = crate::R<OTG_HS_DIEPTXF4_SPEC>;
#[doc = "Register `OTG_HS_DIEPTXF4` writer"]
pub type W = crate::W<OTG_HS_DIEPTXF4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ineptxsa(&mut self) -> INEPTXSA_W<OTG_HS_DIEPTXF4_SPEC, 0> {
        INEPTXSA_W::new(self)
    }
    #[doc = "Bits 16:31 - IN endpoint TxFIFO depth"]
    #[inline(always)]
    #[must_use]
    pub fn ineptxfd(&mut self) -> INEPTXFD_W<OTG_HS_DIEPTXF4_SPEC, 16> {
        INEPTXFD_W::new(self)
    }
