...
pub type CMPMIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EXTTRIGIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMPOKIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ARROKIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DOWNIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmpmie(&mut self) -> CMPMIE_W<IER_SPEC, 0> {
        CMPMIE_W::new(self)
    }
    #[doc = "Bit 1 - Autoreload match Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn exttrigie(&mut self) -> EXTTRIGIE_W<IER_SPEC, 2> {
        EXTTRIGIE_W::new(self)
    }
    #[doc = "Bit 3 - Compare register update OK Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmpokie(&mut self) -> CMPOKIE_W<IER_SPEC, 3> {
        CMPOKIE_W::new(self)
    }
    #[doc = "Bit 4 - Autoreload register update OK Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn arrokie(&mut self) -> ARROKIE_W<IER_SPEC, 4> {
        ARROKIE_W::new(self)
    }
    #[doc = "Bit 5 - Direction change to UP Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn upie(&mut self) -> UPIE_W<IER_SPEC, 5> {
        UPIE_W::new(self)
    }
    #[doc = "Bit 6 - Direction change to down Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn downie(&mut self) -> DOWNIE_W<IER_SPEC, 6> {
        DOWNIE_W::new(self)
    }
