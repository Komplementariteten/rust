...
pub type R = crate::R<AXI_INI3_FN_MOD_SPEC>;
#[doc = "Register `AXI_INI3_FN_MOD` writer"]
pub type W = crate::W<AXI_INI3_FN_MOD_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_iss_override(&mut self) -> READ_ISS_OVERRIDE_W<AXI_INI3_FN_MOD_SPEC, 0> {
        READ_ISS_OVERRIDE_W::new(self)
    }
    #[doc = "Bit 1 - Override ASIB write issuing capability"]
    #[inline(always)]
    #[must_use]
    pub fn write_iss_override(&mut self) -> WRITE_ISS_OVERRIDE_W<AXI_INI3_FN_MOD_SPEC, 1> {
