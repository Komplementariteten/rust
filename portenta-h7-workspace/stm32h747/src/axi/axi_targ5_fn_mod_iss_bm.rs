...
pub type R = crate::R<AXI_TARG5_FN_MOD_ISS_BM_SPEC>;
#[doc = "Register `AXI_TARG5_FN_MOD_ISS_BM` writer"]
pub type W = crate::W<AXI_TARG5_FN_MOD_ISS_BM_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_iss_override(&mut self) -> READ_ISS_OVERRIDE_W<AXI_TARG5_FN_MOD_ISS_BM_SPEC, 0> {
        READ_ISS_OVERRIDE_W::new(self)
    }
    #[doc = "Bit 1 - Switch matrix write issuing override for target"]
    #[inline(always)]
    #[must_use]
    pub fn write_iss_override(&mut self) -> WRITE_ISS_OVERRIDE_W<AXI_TARG5_FN_MOD_ISS_BM_SPEC, 1> {
