...
pub type R = crate::R<AXI_INI1_FN_MOD2_SPEC>;
#[doc = "Register `AXI_INI1_FN_MOD2` writer"]
pub type W = crate::W<AXI_INI1_FN_MOD2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bypass_merge(&mut self) -> BYPASS_MERGE_W<AXI_INI1_FN_MOD2_SPEC, 0> {
