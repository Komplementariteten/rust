...
pub type R = crate::R<AXI_TARG1_FN_MOD_LB_SPEC>;
#[doc = "Register `AXI_TARG1_FN_MOD_LB` writer"]
pub type W = crate::W<AXI_TARG1_FN_MOD_LB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fn_mod_lb(&mut self) -> FN_MOD_LB_W<AXI_TARG1_FN_MOD_LB_SPEC, 0> {
...
#[doc = "AXI interconnect - TARG x long burst functionality modification\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`axi_targ1_fn_mod_lb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`axi_targ1_fn_mod_lb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AXI_TARG1_FN_MOD_LB_SPEC;
impl crate::RegisterSpec for AXI_TARG1_FN_MOD_LB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`axi_targ1_fn_mod_lb::R`](R) reader structure"]
impl crate::Readable for AXI_TARG1_FN_MOD_LB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`axi_targ1_fn_mod_lb::W`](W) writer structure"]
impl crate::Writable for AXI_TARG1_FN_MOD_LB_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets AXI_TARG1_FN_MOD_LB to value 0x04"]
impl crate::Resettable for AXI_TARG1_FN_MOD_LB_SPEC {
