...
pub type R = crate::R<AXI_INI1_FN_MOD_SPEC>;
#[doc = "Register `AXI_INI1_FN_MOD` writer"]
pub type W = crate::W<AXI_INI1_FN_MOD_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_iss_override(&mut self) -> READ_ISS_OVERRIDE_W<AXI_INI1_FN_MOD_SPEC, 0> {
        READ_ISS_OVERRIDE_W::new(self)
    }
    #[doc = "Bit 1 - Override ASIB write issuing capability"]
    #[inline(always)]
    #[must_use]
    pub fn write_iss_override(&mut self) -> WRITE_ISS_OVERRIDE_W<AXI_INI1_FN_MOD_SPEC, 1> {
...
#[doc = "AXI interconnect - INI x issuing functionality modification register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`axi_ini1_fn_mod::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`axi_ini1_fn_mod::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AXI_INI1_FN_MOD_SPEC;
impl crate::RegisterSpec for AXI_INI1_FN_MOD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`axi_ini1_fn_mod::R`](R) reader structure"]
impl crate::Readable for AXI_INI1_FN_MOD_SPEC {}
#[doc = "`write(|w| ..)` method takes [`axi_ini1_fn_mod::W`](W) writer structure"]
impl crate::Writable for AXI_INI1_FN_MOD_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets AXI_INI1_FN_MOD to value 0x04"]
impl crate::Resettable for AXI_INI1_FN_MOD_SPEC {
