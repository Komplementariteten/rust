...
pub type SLVEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DIS_NSS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ABRMOD0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ABRMOD1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RTOEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slven(&mut self) -> SLVEN_W<CR2_SPEC, 0> {
        SLVEN_W::new(self)
    }
    #[doc = "Bit 3 - When the DSI_NSS bit is set, the NSS pin input is ignored"]
    #[inline(always)]
    #[must_use]
    pub fn dis_nss(&mut self) -> DIS_NSS_W<CR2_SPEC, 3> {
        DIS_NSS_W::new(self)
    }
    #[doc = "Bit 4 - 7-bit Address Detection/4-bit Address Detection"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn abren(&mut self) -> ABREN_W<CR2_SPEC, 20> {
        ABREN_W::new(self)
    }
    #[doc = "Bit 21 - ABRMOD0"]
    #[inline(always)]
    #[must_use]
    pub fn abrmod0(&mut self) -> ABRMOD0_W<CR2_SPEC, 21> {
        ABRMOD0_W::new(self)
    }
    #[doc = "Bit 22 - Auto baud rate mode"]
    #[inline(always)]
    #[must_use]
    pub fn abrmod1(&mut self) -> ABRMOD1_W<CR2_SPEC, 22> {
        ABRMOD1_W::new(self)
    }
    #[doc = "Bit 23 - Receiver timeout enable"]
    #[inline(always)]
    #[must_use]
    pub fn rtoen(&mut self) -> RTOEN_W<CR2_SPEC, 23> {
        RTOEN_W::new(self)
    }
    #[doc = "Bits 24:27 - Address of the USART node"]
    #[inline(always)]
