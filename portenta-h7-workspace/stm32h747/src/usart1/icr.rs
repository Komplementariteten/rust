...
pub type TXFECF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TCBGTC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `LBDCF` writer - LIN break detection clear flag"]
pub type LBDCF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RTOCF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `EOBCF` writer - End of block clear flag"]
pub type EOBCF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `UDRCF` writer - SPI slave underrun clear flag"]
pub type UDRCF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txfecf(&mut self) -> TXFECF_W<ICR_SPEC, 5> {
        TXFECF_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcbgtc(&mut self) -> TCBGTC_W<ICR_SPEC, 7> {
        TCBGTC_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn udrcf(&mut self) -> UDRCF_W<ICR_SPEC, 13> {
        UDRCF_W::new(self)
    }
