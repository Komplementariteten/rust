...
pub type DEAT4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RTOIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EOBIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn over8(&mut self) -> OVER8_W<CR1_SPEC, 15> {
        OVER8_W::new(self)
    }
    #[doc = "Bit 16 - DEDT0"]
    #[inline(always)]
    #[must_use]
    pub fn dedt0(&mut self) -> DEDT0_W<CR1_SPEC, 16> {
        DEDT0_W::new(self)
    }
    #[doc = "Bit 17 - DEDT1"]
    #[inline(always)]
    #[must_use]
    pub fn dedt1(&mut self) -> DEDT1_W<CR1_SPEC, 17> {
        DEDT1_W::new(self)
    }
    #[doc = "Bit 18 - DEDT2"]
    #[inline(always)]
    #[must_use]
    pub fn dedt2(&mut self) -> DEDT2_W<CR1_SPEC, 18> {
        DEDT2_W::new(self)
    }
    #[doc = "Bit 19 - DEDT3"]
    #[inline(always)]
    #[must_use]
    pub fn dedt3(&mut self) -> DEDT3_W<CR1_SPEC, 19> {
        DEDT3_W::new(self)
    }
    #[doc = "Bit 20 - Driver Enable de-assertion time"]
    #[inline(always)]
    #[must_use]
    pub fn dedt4(&mut self) -> DEDT4_W<CR1_SPEC, 20> {
        DEDT4_W::new(self)
    }
    #[doc = "Bit 21 - DEAT0"]
    #[inline(always)]
    #[must_use]
    pub fn deat0(&mut self) -> DEAT0_W<CR1_SPEC, 21> {
        DEAT0_W::new(self)
    }
    #[doc = "Bit 22 - DEAT1"]
    #[inline(always)]
    #[must_use]
    pub fn deat1(&mut self) -> DEAT1_W<CR1_SPEC, 22> {
        DEAT1_W::new(self)
    }
    #[doc = "Bit 23 - DEAT2"]
    #[inline(always)]
    #[must_use]
    pub fn deat2(&mut self) -> DEAT2_W<CR1_SPEC, 23> {
        DEAT2_W::new(self)
    }
    #[doc = "Bit 24 - DEAT3"]
    #[inline(always)]
    #[must_use]
    pub fn deat3(&mut self) -> DEAT3_W<CR1_SPEC, 24> {
        DEAT3_W::new(self)
    }
    #[doc = "Bit 25 - Driver Enable assertion time"]
    #[inline(always)]
    #[must_use]
    pub fn deat4(&mut self) -> DEAT4_W<CR1_SPEC, 25> {
        DEAT4_W::new(self)
    }
    #[doc = "Bit 26 - Receiver timeout interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rtoie(&mut self) -> RTOIE_W<CR1_SPEC, 26> {
        RTOIE_W::new(self)
    }
    #[doc = "Bit 27 - End of Block interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn eobie(&mut self) -> EOBIE_W<CR1_SPEC, 27> {
        EOBIE_W::new(self)
    }
    #[doc = "Bit 28 - Word length"]
    #[inline(always)]
