...
pub type R = crate::R<MDMA_C13BRUR_SPEC>;
#[doc = "Register `MDMA_C13BRUR` writer"]
pub type W = crate::W<MDMA_C13BRUR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suv(&mut self) -> SUV_W<MDMA_C13BRUR_SPEC, 0> {
        SUV_W::new(self)
    }
    #[doc = "Bits 16:31 - destination address update"]
    #[inline(always)]
    #[must_use]
    pub fn duv(&mut self) -> DUV_W<MDMA_C13BRUR_SPEC, 16> {
        DUV_W::new(self)
    }
