...
pub type R = crate::R<MDMA_C13LAR_SPEC>;
#[doc = "Register `MDMA_C13LAR` writer"]
pub type W = crate::W<MDMA_C13LAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lar(&mut self) -> LAR_W<MDMA_C13LAR_SPEC, 0> {
        LAR_W::new(self)
    }
