...
pub type R = crate::R<MDMA_C1TBR_SPEC>;
#[doc = "Register `MDMA_C1TBR` writer"]
pub type W = crate::W<MDMA_C1TBR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsel(&mut self) -> TSEL_W<MDMA_C1TBR_SPEC, 0> {
        TSEL_W::new(self)
    }
    #[doc = "Bit 16 - Source BUS select This bit is protected and can be written only if EN is 0."]
    #[inline(always)]
    #[must_use]
    pub fn sbus(&mut self) -> SBUS_W<MDMA_C1TBR_SPEC, 16> {
        SBUS_W::new(self)
    }
    #[doc = "Bit 17 - Destination BUS slect This bit is protected and can be written only if EN is 0."]
    #[inline(always)]
    #[must_use]
    pub fn dbus(&mut self) -> DBUS_W<MDMA_C1TBR_SPEC, 17> {
        DBUS_W::new(self)
    }
