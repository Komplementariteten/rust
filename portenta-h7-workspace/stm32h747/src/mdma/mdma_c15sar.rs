...
pub type R = crate::R<MDMA_C15SAR_SPEC>;
#[doc = "Register `MDMA_C15SAR` writer"]
pub type W = crate::W<MDMA_C15SAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar(&mut self) -> SAR_W<MDMA_C15SAR_SPEC, 0> {
        SAR_W::new(self)
    }
...
#[doc = "MDMA channel x source address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c15sar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdma_c15sar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
