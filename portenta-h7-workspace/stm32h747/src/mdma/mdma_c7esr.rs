...
pub type R = crate::R<MDMA_C7ESR_SPEC>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c7esr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
