...
pub type W = crate::W<MDMA_C7IFCR_SPEC>;
...
pub type CCTCIF7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CBRTIF7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CBTIF7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cctcif7(&mut self) -> CCTCIF7_W<MDMA_C7IFCR_SPEC, 1> {
        CCTCIF7_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cbrtif7(&mut self) -> CBRTIF7_W<MDMA_C7IFCR_SPEC, 2> {
        CBRTIF7_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cbtif7(&mut self) -> CBTIF7_W<MDMA_C7IFCR_SPEC, 3> {
        CBTIF7_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cltcif7(&mut self) -> CLTCIF7_W<MDMA_C7IFCR_SPEC, 4> {
        CLTCIF7_W::new(self)
    }
