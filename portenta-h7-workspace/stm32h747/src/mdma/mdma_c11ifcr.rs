...
pub type W = crate::W<MDMA_C11IFCR_SPEC>;
...
pub type CCTCIF11_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CBRTIF11_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CBTIF11_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cctcif11(&mut self) -> CCTCIF11_W<MDMA_C11IFCR_SPEC, 1> {
        CCTCIF11_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cbrtif11(&mut self) -> CBRTIF11_W<MDMA_C11IFCR_SPEC, 2> {
        CBRTIF11_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cbtif11(&mut self) -> CBTIF11_W<MDMA_C11IFCR_SPEC, 3> {
        CBTIF11_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cltcif11(&mut self) -> CLTCIF11_W<MDMA_C11IFCR_SPEC, 4> {
        CLTCIF11_W::new(self)
    }
