...
pub type R = crate::R<MDMA_C10MAR_SPEC>;
#[doc = "Register `MDMA_C10MAR` writer"]
pub type W = crate::W<MDMA_C10MAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mar(&mut self) -> MAR_W<MDMA_C10MAR_SPEC, 0> {
        MAR_W::new(self)
    }
