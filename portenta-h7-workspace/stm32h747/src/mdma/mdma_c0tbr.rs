...
pub type R = crate::R<MDMA_C0TBR_SPEC>;
#[doc = "Register `MDMA_C0TBR` writer"]
pub type W = crate::W<MDMA_C0TBR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsel(&mut self) -> TSEL_W<MDMA_C0TBR_SPEC, 0> {
        TSEL_W::new(self)
    }
    #[doc = "Bit 16 - Source BUS select This bit is protected and can be written only if EN is 0."]
    #[inline(always)]
    #[must_use]
    pub fn sbus(&mut self) -> SBUS_W<MDMA_C0TBR_SPEC, 16> {
        SBUS_W::new(self)
    }
    #[doc = "Bit 17 - Destination BUS slect This bit is protected and can be written only if EN is 0."]
    #[inline(always)]
    #[must_use]
    pub fn dbus(&mut self) -> DBUS_W<MDMA_C0TBR_SPEC, 17> {
        DBUS_W::new(self)
    }
...
#[doc = "MDMA channel x Trigger and Bus selection Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c0tbr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdma_c0tbr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
