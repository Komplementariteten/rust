...
pub type R = crate::R<MDMA_C8DAR_SPEC>;
#[doc = "Register `MDMA_C8DAR` writer"]
pub type W = crate::W<MDMA_C8DAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dar(&mut self) -> DAR_W<MDMA_C8DAR_SPEC, 0> {
        DAR_W::new(self)
    }
