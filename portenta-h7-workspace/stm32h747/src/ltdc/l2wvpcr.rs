...
pub type R = crate::R<L2WVPCR_SPEC>;
#[doc = "Register `L2WVPCR` writer"]
pub type W = crate::W<L2WVPCR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wvstpos(&mut self) -> WVSTPOS_W<L2WVPCR_SPEC, 0> {
        WVSTPOS_W::new(self)
    }
    #[doc = "Bits 16:26 - Window Vertical Stop Position"]
    #[inline(always)]
    #[must_use]
    pub fn wvsppos(&mut self) -> WVSPPOS_W<L2WVPCR_SPEC, 16> {
        WVSPPOS_W::new(self)
    }
