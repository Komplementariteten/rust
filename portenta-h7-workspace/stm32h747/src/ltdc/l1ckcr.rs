...
pub type R = crate::R<L1CKCR_SPEC>;
#[doc = "Register `L1CKCR` writer"]
pub type W = crate::W<L1CKCR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ckblue(&mut self) -> CKBLUE_W<L1CKCR_SPEC, 0> {
        CKBLUE_W::new(self)
    }
    #[doc = "Bits 8:15 - Color Key Green value"]
    #[inline(always)]
    #[must_use]
    pub fn ckgreen(&mut self) -> CKGREEN_W<L1CKCR_SPEC, 8> {
        CKGREEN_W::new(self)
    }
    #[doc = "Bits 16:23 - Color Key Red value"]
    #[inline(always)]
    #[must_use]
    pub fn ckred(&mut self) -> CKRED_W<L1CKCR_SPEC, 16> {
        CKRED_W::new(self)
    }
