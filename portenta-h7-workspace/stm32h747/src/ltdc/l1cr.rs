...
pub type R = crate::R<L1CR_SPEC>;
#[doc = "Register `L1CR` writer"]
pub type W = crate::W<L1CR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn len(&mut self) -> LEN_W<L1CR_SPEC, 0> {
        LEN_W::new(self)
    }
    #[doc = "Bit 1 - Color Keying Enable"]
    #[inline(always)]
    #[must_use]
    pub fn colken(&mut self) -> COLKEN_W<L1CR_SPEC, 1> {
        COLKEN_W::new(self)
    }
    #[doc = "Bit 4 - Color Look-Up Table Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cluten(&mut self) -> CLUTEN_W<L1CR_SPEC, 4> {
        CLUTEN_W::new(self)
    }
