...
pub type R = crate::R<OUTER_SPEC>;
#[doc = "Register `OUTER` writer"]
pub type W = crate::W<OUTER_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pol1(&mut self) -> POL1_W<OUTER_SPEC, 1> {
        POL1_W::new(self)
    }
    #[doc = "Bit 2 - Output 1 Idle mode"]
    #[inline(always)]
    #[must_use]
    pub fn idlem1(&mut self) -> IDLEM1_W<OUTER_SPEC, 2> {
        IDLEM1_W::new(self)
    }
    #[doc = "Bit 3 - Output 1 Idle State"]
    #[inline(always)]
    #[must_use]
    pub fn idles1(&mut self) -> IDLES1_W<OUTER_SPEC, 3> {
        IDLES1_W::new(self)
    }
    #[doc = "Bits 4:5 - Output 1 Fault state"]
    #[inline(always)]
    #[must_use]
    pub fn fault1(&mut self) -> FAULT1_W<OUTER_SPEC, 4> {
        FAULT1_W::new(self)
    }
    #[doc = "Bit 6 - Output 1 Chopper enable"]
    #[inline(always)]
    #[must_use]
    pub fn chp1(&mut self) -> CHP1_W<OUTER_SPEC, 6> {
        CHP1_W::new(self)
    }
    #[doc = "Bit 7 - Output 1 Deadtime upon burst mode Idle entry"]
    #[inline(always)]
    #[must_use]
    pub fn didl1(&mut self) -> DIDL1_W<OUTER_SPEC, 7> {
        DIDL1_W::new(self)
    }
    #[doc = "Bit 8 - Deadtime enable"]
    #[inline(always)]
    #[must_use]
    pub fn dten(&mut self) -> DTEN_W<OUTER_SPEC, 8> {
        DTEN_W::new(self)
    }
    #[doc = "Bit 9 - Delayed Protection Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dlyprten(&mut self) -> DLYPRTEN_W<OUTER_SPEC, 9> {
        DLYPRTEN_W::new(self)
    }
    #[doc = "Bits 10:12 - Delayed Protection"]
    #[inline(always)]
    #[must_use]
    pub fn dlyprt(&mut self) -> DLYPRT_W<OUTER_SPEC, 10> {
        DLYPRT_W::new(self)
    }
    #[doc = "Bit 17 - Output 2 polarity"]
    #[inline(always)]
    #[must_use]
    pub fn pol2(&mut self) -> POL2_W<OUTER_SPEC, 17> {
        POL2_W::new(self)
    }
    #[doc = "Bit 18 - Output 2 Idle mode"]
    #[inline(always)]
    #[must_use]
    pub fn idlem2(&mut self) -> IDLEM2_W<OUTER_SPEC, 18> {
        IDLEM2_W::new(self)
    }
    #[doc = "Bit 19 - Output 2 Idle State"]
    #[inline(always)]
    #[must_use]
    pub fn idles2(&mut self) -> IDLES2_W<OUTER_SPEC, 19> {
        IDLES2_W::new(self)
    }
    #[doc = "Bits 20:21 - Output 2 Fault state"]
    #[inline(always)]
    #[must_use]
    pub fn fault2(&mut self) -> FAULT2_W<OUTER_SPEC, 20> {
        FAULT2_W::new(self)
    }
    #[doc = "Bit 22 - Output 2 Chopper enable"]
    #[inline(always)]
    #[must_use]
    pub fn chp2(&mut self) -> CHP2_W<OUTER_SPEC, 22> {
        CHP2_W::new(self)
    }
    #[doc = "Bit 23 - Output 2 Deadtime upon burst mode Idle entry"]
    #[inline(always)]
    #[must_use]
    pub fn didl2(&mut self) -> DIDL2_W<OUTER_SPEC, 23> {
        DIDL2_W::new(self)
    }
