...
pub type R = crate::R<SETE1R_SPEC>;
#[doc = "Register `SETE1R` writer"]
pub type W = crate::W<SETE1R_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sst(&mut self) -> SST_W<SETE1R_SPEC, 0> {
        SST_W::new(self)
    }
    #[doc = "Bit 1 - Timer A resynchronizaton"]
    #[inline(always)]
    #[must_use]
    pub fn resync(&mut self) -> RESYNC_W<SETE1R_SPEC, 1> {
        RESYNC_W::new(self)
    }
    #[doc = "Bit 2 - Timer A Period"]
    #[inline(always)]
    #[must_use]
    pub fn per(&mut self) -> PER_W<SETE1R_SPEC, 2> {
        PER_W::new(self)
    }
    #[doc = "Bit 3 - Timer A compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1(&mut self) -> CMP1_W<SETE1R_SPEC, 3> {
        CMP1_W::new(self)
    }
    #[doc = "Bit 4 - Timer A compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<SETE1R_SPEC, 4> {
        CMP2_W::new(self)
    }
    #[doc = "Bit 5 - Timer A compare 3"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3(&mut self) -> CMP3_W<SETE1R_SPEC, 5> {
        CMP3_W::new(self)
    }
    #[doc = "Bit 6 - Timer A compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> CMP4_W<SETE1R_SPEC, 6> {
        CMP4_W::new(self)
    }
    #[doc = "Bit 7 - Master Period"]
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MSTPER_W<SETE1R_SPEC, 7> {
        MSTPER_W::new(self)
    }
    #[doc = "Bit 8 - Master Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> MSTCMP1_W<SETE1R_SPEC, 8> {
        MSTCMP1_W::new(self)
    }
    #[doc = "Bit 9 - Master Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> MSTCMP2_W<SETE1R_SPEC, 9> {
        MSTCMP2_W::new(self)
    }
    #[doc = "Bit 10 - Master Compare 3"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> MSTCMP3_W<SETE1R_SPEC, 10> {
        MSTCMP3_W::new(self)
    }
    #[doc = "Bit 11 - Master Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> MSTCMP4_W<SETE1R_SPEC, 11> {
        MSTCMP4_W::new(self)
    }
    #[doc = "Bit 12 - Timer Event 1"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt1(&mut self) -> TIMEVNT1_W<SETE1R_SPEC, 12> {
        TIMEVNT1_W::new(self)
    }
    #[doc = "Bit 13 - Timer Event 2"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt2(&mut self) -> TIMEVNT2_W<SETE1R_SPEC, 13> {
        TIMEVNT2_W::new(self)
    }
    #[doc = "Bit 14 - Timer Event 3"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt3(&mut self) -> TIMEVNT3_W<SETE1R_SPEC, 14> {
        TIMEVNT3_W::new(self)
    }
    #[doc = "Bit 15 - Timer Event 4"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt4(&mut self) -> TIMEVNT4_W<SETE1R_SPEC, 15> {
        TIMEVNT4_W::new(self)
    }
    #[doc = "Bit 16 - Timer Event 5"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt5(&mut self) -> TIMEVNT5_W<SETE1R_SPEC, 16> {
        TIMEVNT5_W::new(self)
    }
    #[doc = "Bit 17 - Timer Event 6"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt6(&mut self) -> TIMEVNT6_W<SETE1R_SPEC, 17> {
        TIMEVNT6_W::new(self)
    }
    #[doc = "Bit 18 - Timer Event 7"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt7(&mut self) -> TIMEVNT7_W<SETE1R_SPEC, 18> {
        TIMEVNT7_W::new(self)
    }
    #[doc = "Bit 19 - Timer Event 8"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt8(&mut self) -> TIMEVNT8_W<SETE1R_SPEC, 19> {
        TIMEVNT8_W::new(self)
    }
    #[doc = "Bit 20 - Timer Event 9"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt9(&mut self) -> TIMEVNT9_W<SETE1R_SPEC, 20> {
        TIMEVNT9_W::new(self)
    }
    #[doc = "Bit 21 - External Event 1"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> EXTEVNT1_W<SETE1R_SPEC, 21> {
        EXTEVNT1_W::new(self)
    }
    #[doc = "Bit 22 - External Event 2"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> EXTEVNT2_W<SETE1R_SPEC, 22> {
        EXTEVNT2_W::new(self)
    }
    #[doc = "Bit 23 - External Event 3"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> EXTEVNT3_W<SETE1R_SPEC, 23> {
        EXTEVNT3_W::new(self)
    }
    #[doc = "Bit 24 - External Event 4"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> EXTEVNT4_W<SETE1R_SPEC, 24> {
        EXTEVNT4_W::new(self)
    }
    #[doc = "Bit 25 - External Event 5"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> EXTEVNT5_W<SETE1R_SPEC, 25> {
        EXTEVNT5_W::new(self)
    }
    #[doc = "Bit 26 - External Event 6"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> EXTEVNT6_W<SETE1R_SPEC, 26> {
        EXTEVNT6_W::new(self)
    }
    #[doc = "Bit 27 - External Event 7"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> EXTEVNT7_W<SETE1R_SPEC, 27> {
        EXTEVNT7_W::new(self)
    }
    #[doc = "Bit 28 - External Event 8"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> EXTEVNT8_W<SETE1R_SPEC, 28> {
        EXTEVNT8_W::new(self)
    }
    #[doc = "Bit 29 - External Event 9"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> EXTEVNT9_W<SETE1R_SPEC, 29> {
        EXTEVNT9_W::new(self)
    }
    #[doc = "Bit 30 - External Event 10"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> EXTEVNT10_W<SETE1R_SPEC, 30> {
        EXTEVNT10_W::new(self)
    }
    #[doc = "Bit 31 - Registers update (transfer preload to active)"]
    #[inline(always)]
    #[must_use]
    pub fn update(&mut self) -> UPDATE_W<SETE1R_SPEC, 31> {
        UPDATE_W::new(self)
    }
