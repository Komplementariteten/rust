...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srt(&mut self) -> SRT_W<RSTE1R_SPEC, 0> {
        SRT_W::new(self)
    }
    #[doc = "Bit 1 - RESYNC"]
    #[inline(always)]
    #[must_use]
    pub fn resync(&mut self) -> RESYNC_W<RSTE1R_SPEC, 1> {
        RESYNC_W::new(self)
    }
    #[doc = "Bit 2 - PER"]
    #[inline(always)]
    #[must_use]
    pub fn per(&mut self) -> PER_W<RSTE1R_SPEC, 2> {
        PER_W::new(self)
    }
    #[doc = "Bit 3 - CMP1"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1(&mut self) -> CMP1_W<RSTE1R_SPEC, 3> {
        CMP1_W::new(self)
    }
    #[doc = "Bit 4 - CMP2"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<RSTE1R_SPEC, 4> {
        CMP2_W::new(self)
    }
    #[doc = "Bit 5 - CMP3"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3(&mut self) -> CMP3_W<RSTE1R_SPEC, 5> {
        CMP3_W::new(self)
    }
    #[doc = "Bit 6 - CMP4"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> CMP4_W<RSTE1R_SPEC, 6> {
        CMP4_W::new(self)
    }
    #[doc = "Bit 7 - MSTPER"]
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MSTPER_W<RSTE1R_SPEC, 7> {
        MSTPER_W::new(self)
    }
    #[doc = "Bit 8 - MSTCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> MSTCMP1_W<RSTE1R_SPEC, 8> {
        MSTCMP1_W::new(self)
    }
    #[doc = "Bit 9 - MSTCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> MSTCMP2_W<RSTE1R_SPEC, 9> {
        MSTCMP2_W::new(self)
    }
    #[doc = "Bit 10 - MSTCMP3"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> MSTCMP3_W<RSTE1R_SPEC, 10> {
        MSTCMP3_W::new(self)
    }
    #[doc = "Bit 11 - MSTCMP4"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> MSTCMP4_W<RSTE1R_SPEC, 11> {
        MSTCMP4_W::new(self)
    }
    #[doc = "Bit 12 - TIMEVNT1"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt1(&mut self) -> TIMEVNT1_W<RSTE1R_SPEC, 12> {
        TIMEVNT1_W::new(self)
    }
    #[doc = "Bit 13 - TIMEVNT2"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt2(&mut self) -> TIMEVNT2_W<RSTE1R_SPEC, 13> {
        TIMEVNT2_W::new(self)
    }
    #[doc = "Bit 14 - TIMEVNT3"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt3(&mut self) -> TIMEVNT3_W<RSTE1R_SPEC, 14> {
        TIMEVNT3_W::new(self)
    }
    #[doc = "Bit 15 - TIMEVNT4"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt4(&mut self) -> TIMEVNT4_W<RSTE1R_SPEC, 15> {
        TIMEVNT4_W::new(self)
    }
    #[doc = "Bit 16 - TIMEVNT5"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt5(&mut self) -> TIMEVNT5_W<RSTE1R_SPEC, 16> {
        TIMEVNT5_W::new(self)
    }
    #[doc = "Bit 17 - TIMEVNT6"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt6(&mut self) -> TIMEVNT6_W<RSTE1R_SPEC, 17> {
        TIMEVNT6_W::new(self)
    }
    #[doc = "Bit 18 - TIMEVNT7"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt7(&mut self) -> TIMEVNT7_W<RSTE1R_SPEC, 18> {
        TIMEVNT7_W::new(self)
    }
    #[doc = "Bit 19 - TIMEVNT8"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt8(&mut self) -> TIMEVNT8_W<RSTE1R_SPEC, 19> {
        TIMEVNT8_W::new(self)
    }
    #[doc = "Bit 20 - TIMEVNT9"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt9(&mut self) -> TIMEVNT9_W<RSTE1R_SPEC, 20> {
        TIMEVNT9_W::new(self)
    }
    #[doc = "Bit 21 - EXTEVNT1"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> EXTEVNT1_W<RSTE1R_SPEC, 21> {
        EXTEVNT1_W::new(self)
    }
    #[doc = "Bit 22 - EXTEVNT2"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> EXTEVNT2_W<RSTE1R_SPEC, 22> {
        EXTEVNT2_W::new(self)
    }
    #[doc = "Bit 23 - EXTEVNT3"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> EXTEVNT3_W<RSTE1R_SPEC, 23> {
        EXTEVNT3_W::new(self)
    }
    #[doc = "Bit 24 - EXTEVNT4"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> EXTEVNT4_W<RSTE1R_SPEC, 24> {
        EXTEVNT4_W::new(self)
    }
    #[doc = "Bit 25 - EXTEVNT5"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> EXTEVNT5_W<RSTE1R_SPEC, 25> {
        EXTEVNT5_W::new(self)
    }
    #[doc = "Bit 26 - EXTEVNT6"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> EXTEVNT6_W<RSTE1R_SPEC, 26> {
        EXTEVNT6_W::new(self)
    }
    #[doc = "Bit 27 - EXTEVNT7"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> EXTEVNT7_W<RSTE1R_SPEC, 27> {
        EXTEVNT7_W::new(self)
    }
    #[doc = "Bit 28 - EXTEVNT8"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> EXTEVNT8_W<RSTE1R_SPEC, 28> {
        EXTEVNT8_W::new(self)
    }
    #[doc = "Bit 29 - EXTEVNT9"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> EXTEVNT9_W<RSTE1R_SPEC, 29> {
        EXTEVNT9_W::new(self)
    }
    #[doc = "Bit 30 - EXTEVNT10"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> EXTEVNT10_W<RSTE1R_SPEC, 30> {
        EXTEVNT10_W::new(self)
    }
    #[doc = "Bit 31 - UPDATE"]
    #[inline(always)]
    #[must_use]
    pub fn update(&mut self) -> UPDATE_W<RSTE1R_SPEC, 31> {
        UPDATE_W::new(self)
    }
