...
pub type F1SA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn f1sa(&mut self) -> F1SA_W<FDCAN_RXF1C_SPEC, 2> {
        F1SA_W::new(self)
    }
    #[doc = "Bits 16:22 - Rx FIFO 1 Size"]
    #[inline(always)]
    #[must_use]
    pub fn f1s(&mut self) -> F1S_W<FDCAN_RXF1C_SPEC, 16> {
        F1S_W::new(self)
    }
    #[doc = "Bits 24:30 - Rx FIFO 1 Watermark"]
    #[inline(always)]
    #[must_use]
    pub fn f1wm(&mut self) -> F1WM_W<FDCAN_RXF1C_SPEC, 24> {
        F1WM_W::new(self)
    }
