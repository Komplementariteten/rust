...
pub type R = crate::R<FDCAN_TXBC_SPEC>;
#[doc = "Register `FDCAN_TXBC` writer"]
pub type W = crate::W<FDCAN_TXBC_SPEC>;
...
pub type TBSA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tbsa(&mut self) -> TBSA_W<FDCAN_TXBC_SPEC, 2> {
        TBSA_W::new(self)
    }
    #[doc = "Bits 16:21 - Number of Dedicated Transmit Buffers"]
    #[inline(always)]
    #[must_use]
    pub fn ndtb(&mut self) -> NDTB_W<FDCAN_TXBC_SPEC, 16> {
        NDTB_W::new(self)
    }
    #[doc = "Bits 24:29 - Transmit FIFO/Queue Size"]
    #[inline(always)]
    #[must_use]
    pub fn tfqs(&mut self) -> TFQS_W<FDCAN_TXBC_SPEC, 24> {
        TFQS_W::new(self)
    }
    #[doc = "Bit 30 - Tx FIFO/Queue Mode"]
    #[inline(always)]
    #[must_use]
    pub fn tfqm(&mut self) -> TFQM_W<FDCAN_TXBC_SPEC, 30> {
        TFQM_W::new(self)
    }
