...
pub type R = crate::R<FDCAN_TURCF_SPEC>;
#[doc = "Register `FDCAN_TURCF` writer"]
pub type W = crate::W<FDCAN_TURCF_SPEC>;
...
pub type DC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
#[doc = "Field `ELT` reader - Enable Local Time"]
pub type ELT_R = crate::BitReader;
#[doc = "Field `ELT` writer - Enable Local Time"]
pub type ELT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ncl(&mut self) -> NCL_W<FDCAN_TURCF_SPEC, 0> {
        NCL_W::new(self)
    }
    #[doc = "Bits 16:29 - Denominator Configuration."]
    #[inline(always)]
    #[must_use]
    pub fn dc(&mut self) -> DC_W<FDCAN_TURCF_SPEC, 16> {
        DC_W::new(self)
    }
    #[doc = "Bit 31 - Enable Local Time"]
    #[inline(always)]
    #[must_use]
    pub fn elt(&mut self) -> ELT_W<FDCAN_TURCF_SPEC, 31> {
        ELT_W::new(self)
    }
