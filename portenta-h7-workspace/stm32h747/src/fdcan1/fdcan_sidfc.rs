...
pub type R = crate::R<FDCAN_SIDFC_SPEC>;
#[doc = "Register `FDCAN_SIDFC` writer"]
pub type W = crate::W<FDCAN_SIDFC_SPEC>;
...
pub type FLSSA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flssa(&mut self) -> FLSSA_W<FDCAN_SIDFC_SPEC, 2> {
        FLSSA_W::new(self)
    }
    #[doc = "Bits 16:23 - List Size Standard"]
    #[inline(always)]
    #[must_use]
    pub fn lss(&mut self) -> LSS_W<FDCAN_SIDFC_SPEC, 16> {
        LSS_W::new(self)
    }
