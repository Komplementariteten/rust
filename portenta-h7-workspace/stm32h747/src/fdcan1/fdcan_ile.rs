...
pub type R = crate::R<FDCAN_ILE_SPEC>;
#[doc = "Register `FDCAN_ILE` writer"]
pub type W = crate::W<FDCAN_ILE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint0(&mut self) -> EINT0_W<FDCAN_ILE_SPEC, 0> {
        EINT0_W::new(self)
    }
    #[doc = "Bit 1 - Enable Interrupt Line 1"]
    #[inline(always)]
    #[must_use]
    pub fn eint1(&mut self) -> EINT1_W<FDCAN_ILE_SPEC, 1> {
        EINT1_W::new(self)
    }
