...
pub type R = crate::R<FDCAN_TXBCIE_SPEC>;
#[doc = "Register `FDCAN_TXBCIE` writer"]
pub type W = crate::W<FDCAN_TXBCIE_SPEC>;
...
pub type CF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cf(&mut self) -> CF_W<FDCAN_TXBCIE_SPEC, 0> {
        CF_W::new(self)
    }
