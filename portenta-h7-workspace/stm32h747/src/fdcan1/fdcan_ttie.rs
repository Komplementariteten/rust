...
pub type R = crate::R<FDCAN_TTIE_SPEC>;
#[doc = "Register `FDCAN_TTIE` writer"]
pub type W = crate::W<FDCAN_TTIE_SPEC>;
...
pub type SBCE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SMCE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CSME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SOGE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RTMIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TTMIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWEE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type GTWE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type GTDE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type GTEE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TXUE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TXOE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SE1E_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SE2E_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ELCE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IWTGE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WTE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CERE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sbce(&mut self) -> SBCE_W<FDCAN_TTIE_SPEC, 0> {
        SBCE_W::new(self)
    }
    #[doc = "Bit 1 - Start of Matrix Cycle Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn smce(&mut self) -> SMCE_W<FDCAN_TTIE_SPEC, 1> {
        SMCE_W::new(self)
    }
    #[doc = "Bit 2 - Change of Synchronization Mode Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn csme(&mut self) -> CSME_W<FDCAN_TTIE_SPEC, 2> {
        CSME_W::new(self)
    }
    #[doc = "Bit 3 - Start of Gap Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn soge(&mut self) -> SOGE_W<FDCAN_TTIE_SPEC, 3> {
        SOGE_W::new(self)
    }
    #[doc = "Bit 4 - Register Time Mark Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rtmie(&mut self) -> RTMIE_W<FDCAN_TTIE_SPEC, 4> {
        RTMIE_W::new(self)
    }
    #[doc = "Bit 5 - Trigger Time Mark Event Internal Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ttmie(&mut self) -> TTMIE_W<FDCAN_TTIE_SPEC, 5> {
        TTMIE_W::new(self)
    }
    #[doc = "Bit 6 - Stop Watch Event Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn swee(&mut self) -> SWEE_W<FDCAN_TTIE_SPEC, 6> {
        SWEE_W::new(self)
    }
    #[doc = "Bit 7 - Global Time Wrap Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gtwe(&mut self) -> GTWE_W<FDCAN_TTIE_SPEC, 7> {
        GTWE_W::new(self)
    }
    #[doc = "Bit 8 - Global Time Discontinuity Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gtde(&mut self) -> GTDE_W<FDCAN_TTIE_SPEC, 8> {
        GTDE_W::new(self)
    }
    #[doc = "Bit 9 - Global Time Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gtee(&mut self) -> GTEE_W<FDCAN_TTIE_SPEC, 9> {
        GTEE_W::new(self)
    }
    #[doc = "Bit 10 - Tx Count Underflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txue(&mut self) -> TXUE_W<FDCAN_TTIE_SPEC, 10> {
        TXUE_W::new(self)
    }
    #[doc = "Bit 11 - Tx Count Overflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txoe(&mut self) -> TXOE_W<FDCAN_TTIE_SPEC, 11> {
        TXOE_W::new(self)
    }
    #[doc = "Bit 12 - Scheduling Error 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn se1e(&mut self) -> SE1E_W<FDCAN_TTIE_SPEC, 12> {
        SE1E_W::new(self)
    }
    #[doc = "Bit 13 - Scheduling Error 2 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn se2e(&mut self) -> SE2E_W<FDCAN_TTIE_SPEC, 13> {
        SE2E_W::new(self)
    }
    #[doc = "Bit 14 - Change Error Level Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn elce(&mut self) -> ELCE_W<FDCAN_TTIE_SPEC, 14> {
        ELCE_W::new(self)
    }
    #[doc = "Bit 15 - Initialization Watch Trigger Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn iwtge(&mut self) -> IWTGE_W<FDCAN_TTIE_SPEC, 15> {
        IWTGE_W::new(self)
    }
    #[doc = "Bit 16 - Watch Trigger Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wte(&mut self) -> WTE_W<FDCAN_TTIE_SPEC, 16> {
        WTE_W::new(self)
    }
    #[doc = "Bit 17 - Application Watchdog Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn awe(&mut self) -> AWE_W<FDCAN_TTIE_SPEC, 17> {
        AWE_W::new(self)
    }
    #[doc = "Bit 18 - Configuration Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cere(&mut self) -> CERE_W<FDCAN_TTIE_SPEC, 18> {
        CERE_W::new(self)
    }
