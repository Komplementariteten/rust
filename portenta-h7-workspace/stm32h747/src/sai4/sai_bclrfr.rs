...
pub type W = crate::W<SAI_BCLRFR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn covrudr(&mut self) -> COVRUDR_W<SAI_BCLRFR_SPEC, 0> {
        COVRUDR_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmutedet(&mut self) -> CMUTEDET_W<SAI_BCLRFR_SPEC, 1> {
        CMUTEDET_W::new(self)
    }
...
= 0) and NODIV = 0 in the SAI_xCR1 register. Reading this bit always returns the value 0."]
    #[inline(always)]
    #[must_use]
    pub fn cwckcfg(&mut self) -> CWCKCFG_W<SAI_BCLRFR_SPEC, 2> {
        CWCKCFG_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccnrdy(&mut self) -> CCNRDY_W<SAI_BCLRFR_SPEC, 4> {
        CCNRDY_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cafsdet(&mut self) -> CAFSDET_W<SAI_BCLRFR_SPEC, 5> {
        CAFSDET_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn clfsdet(&mut self) -> CLFSDET_W<SAI_BCLRFR_SPEC, 6> {
        CLFSDET_W::new(self)
    }
