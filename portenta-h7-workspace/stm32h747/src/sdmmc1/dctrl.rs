...
pub type DTMODE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type RWSTART_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BOOTACKEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FIFORST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rwstart(&mut self) -> RWSTART_W<DCTRL_SPEC, 8> {
        RWSTART_W::new(self)
    }
    #[doc = "Bit 9 - Read wait stop This bit is written by firmware and auto cleared by hardware when the DPSM moves from the READ_WAIT state to the WAIT_R or IDLE state."]
    #[inline(always)]
    #[must_use]
    pub fn rwstop(&mut self) -> RWSTOP_W<DCTRL_SPEC, 9> {
        RWSTOP_W::new(self)
    }
    #[doc = "Bit 10 - Read wait mode. This bit can only be written by firmware when DPSM is inactive (DPSMACT = 0)."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn bootacken(&mut self) -> BOOTACKEN_W<DCTRL_SPEC, 12> {
        BOOTACKEN_W::new(self)
    }
    #[doc = "Bit 13 - FIFO reset, will flush any remaining data. This bit can only be written by firmware when IDMAEN= 0 and DPSM is active (DPSMACT = 1). This bit will only take effect when a transfer error or transfer hold occurs."]
    #[inline(always)]
    #[must_use]
    pub fn fiforst(&mut self) -> FIFORST_W<DCTRL_SPEC, 13> {
        FIFORST_W::new(self)
    }
