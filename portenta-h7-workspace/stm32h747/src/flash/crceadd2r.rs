...
pub type R = crate::R<CRCEADD2R_SPEC>;
#[doc = "Register `CRCEADD2R` writer"]
pub type W = crate::W<CRCEADD2R_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crc_end_addr(&mut self) -> CRC_END_ADDR_W<CRCEADD2R_SPEC, 0> {
