...
pub type R = crate::R<CRCCR2_SPEC>;
#[doc = "Register `CRCCR2` writer"]
pub type W = crate::W<CRCCR2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crc_sect(&mut self) -> CRC_SECT_W<CRCCR2_SPEC, 0> {
        CRC_SECT_W::new(self)
    }
    #[doc = "Bit 7 - Bank 2 CRC select bit"]
    #[inline(always)]
    #[must_use]
    pub fn all_bank(&mut self) -> ALL_BANK_W<CRCCR2_SPEC, 7> {
        ALL_BANK_W::new(self)
    }
    #[doc = "Bit 8 - Bank 2 CRC sector mode select bit"]
    #[inline(always)]
    #[must_use]
    pub fn crc_by_sect(&mut self) -> CRC_BY_SECT_W<CRCCR2_SPEC, 8> {
        CRC_BY_SECT_W::new(self)
    }
    #[doc = "Bit 9 - Bank 2 CRC sector select bit"]
    #[inline(always)]
    #[must_use]
    pub fn add_sect(&mut self) -> ADD_SECT_W<CRCCR2_SPEC, 9> {
        ADD_SECT_W::new(self)
    }
    #[doc = "Bit 10 - Bank 2 CRC sector list clear bit"]
    #[inline(always)]
    #[must_use]
    pub fn clean_sect(&mut self) -> CLEAN_SECT_W<CRCCR2_SPEC, 10> {
        CLEAN_SECT_W::new(self)
    }
    #[doc = "Bit 16 - Bank 2 CRC start bit"]
    #[inline(always)]
    #[must_use]
    pub fn start_crc(&mut self) -> START_CRC_W<CRCCR2_SPEC, 16> {
        START_CRC_W::new(self)
    }
    #[doc = "Bit 17 - Bank 2 CRC clear bit"]
    #[inline(always)]
    #[must_use]
    pub fn clean_crc(&mut self) -> CLEAN_CRC_W<CRCCR2_SPEC, 17> {
        CLEAN_CRC_W::new(self)
    }
    #[doc = "Bits 20:21 - Bank 2 CRC burst size"]
    #[inline(always)]
    #[must_use]
    pub fn crc_burst(&mut self) -> CRC_BURST_W<CRCCR2_SPEC, 20> {
...
#[doc = "FLASH CRC control register for bank 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`crccr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`crccr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CRCCR2_SPEC;
impl crate::RegisterSpec for CRCCR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`crccr2::R`](R) reader structure"]
impl crate::Readable for CRCCR2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`crccr2::W`](W) writer structure"]
impl crate::Writable for CRCCR2_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CRCCR2 to value 0"]
impl crate::Resettable for CRCCR2_SPEC {
