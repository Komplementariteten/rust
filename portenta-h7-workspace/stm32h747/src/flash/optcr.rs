...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn optstart(&mut self) -> OPTSTART_W<OPTCR_SPEC, 1> {
        OPTSTART_W::new(self)
    }
    #[doc = "Bit 4 - Flash mass erase enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn mer(&mut self) -> MER_W<OPTCR_SPEC, 4> {
        MER_W::new(self)
    }
    #[doc = "Bit 30 - Option byte change error interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn optchangeerrie(&mut self) -> OPTCHANGEERRIE_W<OPTCR_SPEC, 30> {
        OPTCHANGEERRIE_W::new(self)
    }
    #[doc = "Bit 31 - Bank swapping configuration bit"]
    #[inline(always)]
    #[must_use]
    pub fn swap_bank(&mut self) -> SWAP_BANK_W<OPTCR_SPEC, 31> {
