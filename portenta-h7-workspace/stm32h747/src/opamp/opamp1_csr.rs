...
pub type VP_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opaen(&mut self) -> OPAEN_W<OPAMP1_CSR_SPEC, 0> {
        OPAEN_W::new(self)
    }
    #[doc = "Bit 1 - Force internal reference on VP (reserved for test"]
    #[inline(always)]
    #[must_use]
    pub fn force_vp(&mut self) -> FORCE_VP_W<OPAMP1_CSR_SPEC, 1> {
        FORCE_VP_W::new(self)
    }
    #[doc = "Bits 2:3 - Operational amplifier PGA mode"]
    #[inline(always)]
    #[must_use]
    pub fn vp_sel(&mut self) -> VP_SEL_W<OPAMP1_CSR_SPEC, 2> {
        VP_SEL_W::new(self)
    }
    #[doc = "Bits 5:6 - Inverting input selection"]
    #[inline(always)]
    #[must_use]
    pub fn vm_sel(&mut self) -> VM_SEL_W<OPAMP1_CSR_SPEC, 5> {
        VM_SEL_W::new(self)
    }
    #[doc = "Bit 8 - Operational amplifier high-speed mode"]
    #[inline(always)]
    #[must_use]
    pub fn opahsm(&mut self) -> OPAHSM_W<OPAMP1_CSR_SPEC, 8> {
        OPAHSM_W::new(self)
    }
    #[doc = "Bit 11 - Calibration mode enabled"]
    #[inline(always)]
    #[must_use]
    pub fn calon(&mut self) -> CALON_W<OPAMP1_CSR_SPEC, 11> {
        CALON_W::new(self)
    }
    #[doc = "Bits 12:13 - Calibration selection"]
    #[inline(always)]
    #[must_use]
    pub fn calsel(&mut self) -> CALSEL_W<OPAMP1_CSR_SPEC, 12> {
        CALSEL_W::new(self)
    }
    #[doc = "Bits 14:17 - allows to switch from AOP offset trimmed values to AOP offset"]
    #[inline(always)]
    #[must_use]
    pub fn pga_gain(&mut self) -> PGA_GAIN_W<OPAMP1_CSR_SPEC, 14> {
        PGA_GAIN_W::new(self)
    }
    #[doc = "Bit 18 - User trimming enable"]
    #[inline(always)]
    #[must_use]
    pub fn usertrim(&mut self) -> USERTRIM_W<OPAMP1_CSR_SPEC, 18> {
        USERTRIM_W::new(self)
    }
    #[doc = "Bit 29 - OPAMP calibration reference voltage output control (reserved for test)"]
    #[inline(always)]
    #[must_use]
    pub fn tstref(&mut self) -> TSTREF_W<OPAMP1_CSR_SPEC, 29> {
        TSTREF_W::new(self)
    }
    #[doc = "Bit 30 - Operational amplifier calibration output"]
    #[inline(always)]
    #[must_use]
    pub fn calout(&mut self) -> CALOUT_W<OPAMP1_CSR_SPEC, 30> {
        CALOUT_W::new(self)
    }
