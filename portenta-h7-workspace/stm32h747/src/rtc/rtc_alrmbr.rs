...
pub type R = crate::R<RTC_ALRMBR_SPEC>;
#[doc = "Register `RTC_ALRMBR` writer"]
pub type W = crate::W<RTC_ALRMBR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn su(&mut self) -> SU_W<RTC_ALRMBR_SPEC, 0> {
        SU_W::new(self)
    }
    #[doc = "Bits 4:6 - Second tens in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn st(&mut self) -> ST_W<RTC_ALRMBR_SPEC, 4> {
        ST_W::new(self)
    }
    #[doc = "Bit 7 - Alarm B seconds mask"]
    #[inline(always)]
    #[must_use]
    pub fn msk1(&mut self) -> MSK1_W<RTC_ALRMBR_SPEC, 7> {
        MSK1_W::new(self)
    }
    #[doc = "Bits 8:11 - Minute units in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn mnu(&mut self) -> MNU_W<RTC_ALRMBR_SPEC, 8> {
        MNU_W::new(self)
    }
    #[doc = "Bits 12:14 - Minute tens in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn mnt(&mut self) -> MNT_W<RTC_ALRMBR_SPEC, 12> {
        MNT_W::new(self)
    }
    #[doc = "Bit 15 - Alarm B minutes mask"]
    #[inline(always)]
    #[must_use]
    pub fn msk2(&mut self) -> MSK2_W<RTC_ALRMBR_SPEC, 15> {
        MSK2_W::new(self)
    }
    #[doc = "Bits 16:19 - Hour units in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn hu(&mut self) -> HU_W<RTC_ALRMBR_SPEC, 16> {
        HU_W::new(self)
    }
    #[doc = "Bits 20:21 - Hour tens in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn ht(&mut self) -> HT_W<RTC_ALRMBR_SPEC, 20> {
        HT_W::new(self)
    }
    #[doc = "Bit 22 - AM/PM notation"]
    #[inline(always)]
    #[must_use]
    pub fn pm(&mut self) -> PM_W<RTC_ALRMBR_SPEC, 22> {
        PM_W::new(self)
    }
    #[doc = "Bit 23 - Alarm B hours mask"]
    #[inline(always)]
    #[must_use]
    pub fn msk3(&mut self) -> MSK3_W<RTC_ALRMBR_SPEC, 23> {
        MSK3_W::new(self)
    }
    #[doc = "Bits 24:27 - Date units or day in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn du(&mut self) -> DU_W<RTC_ALRMBR_SPEC, 24> {
        DU_W::new(self)
    }
    #[doc = "Bits 28:29 - Date tens in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DT_W<RTC_ALRMBR_SPEC, 28> {
        DT_W::new(self)
    }
    #[doc = "Bit 30 - Week day selection"]
    #[inline(always)]
    #[must_use]
    pub fn wdsel(&mut self) -> WDSEL_W<RTC_ALRMBR_SPEC, 30> {
        WDSEL_W::new(self)
    }
    #[doc = "Bit 31 - Alarm B date mask"]
    #[inline(always)]
    #[must_use]
    pub fn msk4(&mut self) -> MSK4_W<RTC_ALRMBR_SPEC, 31> {
        MSK4_W::new(self)
    }
...
pub struct RTC_ALRMBR_SPEC;
impl crate::RegisterSpec for RTC_ALRMBR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rtc_alrmbr::R`](R) reader structure"]
impl crate::Readable for RTC_ALRMBR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`rtc_alrmbr::W`](W) writer structure"]
impl crate::Writable for RTC_ALRMBR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RTC_ALRMBR to value 0"]
impl crate::Resettable for RTC_ALRMBR_SPEC {
