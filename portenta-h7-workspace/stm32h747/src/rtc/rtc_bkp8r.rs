...
pub type R = crate::R<RTC_BKP8R_SPEC>;
#[doc = "Register `RTC_BKP8R` writer"]
pub type W = crate::W<RTC_BKP8R_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkp(&mut self) -> BKP_W<RTC_BKP8R_SPEC, 0> {
        BKP_W::new(self)
    }
...
#[doc = "RTC backup registers\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rtc_bkp8r::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rtc_bkp8r::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RTC_BKP8R_SPEC;
impl crate::RegisterSpec for RTC_BKP8R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rtc_bkp8r::R`](R) reader structure"]
impl crate::Readable for RTC_BKP8R_SPEC {}
#[doc = "`write(|w| ..)` method takes [`rtc_bkp8r::W`](W) writer structure"]
impl crate::Writable for RTC_BKP8R_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RTC_BKP8R to value 0"]
impl crate::Resettable for RTC_BKP8R_SPEC {
