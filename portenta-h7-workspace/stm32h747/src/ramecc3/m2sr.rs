...
pub type R = crate::R<M2SR_SPEC>;
#[doc = "Register `M2SR` writer"]
pub type W = crate::W<M2SR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sedcf(&mut self) -> SEDCF_W<M2SR_SPEC, 0> {
        SEDCF_W::new(self)
    }
    #[doc = "Bit 1 - ECC double error detected flag"]
    #[inline(always)]
    #[must_use]
    pub fn dedf(&mut self) -> DEDF_W<M2SR_SPEC, 1> {
        DEDF_W::new(self)
    }
    #[doc = "Bit 2 - ECC double error on byte write (BW) detected flag"]
    #[inline(always)]
    #[must_use]
    pub fn debwdf(&mut self) -> DEBWDF_W<M2SR_SPEC, 2> {
        DEBWDF_W::new(self)
    }
