...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee6src(&mut self) -> EE6SRC_W<EECR3_SPEC, 0> {
        EE6SRC_W::new(self)
    }
    #[doc = "Bit 2 - EE6POL"]
    #[inline(always)]
    #[must_use]
    pub fn ee6pol(&mut self) -> EE6POL_W<EECR3_SPEC, 2> {
        EE6POL_W::new(self)
    }
    #[doc = "Bits 3:4 - EE6SNS"]
    #[inline(always)]
    #[must_use]
    pub fn ee6sns(&mut self) -> EE6SNS_W<EECR3_SPEC, 3> {
        EE6SNS_W::new(self)
    }
    #[doc = "Bits 6:7 - EE7SRC"]
    #[inline(always)]
    #[must_use]
    pub fn ee7src(&mut self) -> EE7SRC_W<EECR3_SPEC, 6> {
        EE7SRC_W::new(self)
    }
    #[doc = "Bit 8 - EE7POL"]
    #[inline(always)]
    #[must_use]
    pub fn ee7pol(&mut self) -> EE7POL_W<EECR3_SPEC, 8> {
        EE7POL_W::new(self)
    }
    #[doc = "Bits 9:10 - EE7SNS"]
    #[inline(always)]
    #[must_use]
    pub fn ee7sns(&mut self) -> EE7SNS_W<EECR3_SPEC, 9> {
        EE7SNS_W::new(self)
    }
    #[doc = "Bits 12:13 - EE8SRC"]
    #[inline(always)]
    #[must_use]
    pub fn ee8src(&mut self) -> EE8SRC_W<EECR3_SPEC, 12> {
        EE8SRC_W::new(self)
    }
    #[doc = "Bit 14 - EE8POL"]
    #[inline(always)]
    #[must_use]
    pub fn ee8pol(&mut self) -> EE8POL_W<EECR3_SPEC, 14> {
        EE8POL_W::new(self)
    }
    #[doc = "Bits 15:16 - EE8SNS"]
    #[inline(always)]
    #[must_use]
    pub fn ee8sns(&mut self) -> EE8SNS_W<EECR3_SPEC, 15> {
        EE8SNS_W::new(self)
    }
    #[doc = "Bits 18:19 - EE9SRC"]
    #[inline(always)]
    #[must_use]
    pub fn ee9src(&mut self) -> EE9SRC_W<EECR3_SPEC, 18> {
        EE9SRC_W::new(self)
    }
    #[doc = "Bit 20 - EE9POL"]
    #[inline(always)]
    #[must_use]
    pub fn ee9pol(&mut self) -> EE9POL_W<EECR3_SPEC, 20> {
        EE9POL_W::new(self)
    }
    #[doc = "Bits 21:22 - EE9SNS"]
    #[inline(always)]
    #[must_use]
    pub fn ee9sns(&mut self) -> EE9SNS_W<EECR3_SPEC, 21> {
        EE9SNS_W::new(self)
    }
    #[doc = "Bits 24:25 - EE10SRC"]
    #[inline(always)]
    #[must_use]
    pub fn ee10src(&mut self) -> EE10SRC_W<EECR3_SPEC, 24> {
        EE10SRC_W::new(self)
    }
    #[doc = "Bit 26 - EE10POL"]
    #[inline(always)]
    #[must_use]
    pub fn ee10pol(&mut self) -> EE10POL_W<EECR3_SPEC, 26> {
        EE10POL_W::new(self)
    }
    #[doc = "Bits 27:28 - EE10SNS"]
    #[inline(always)]
    #[must_use]
    pub fn ee10sns(&mut self) -> EE10SNS_W<EECR3_SPEC, 27> {
        EE10SNS_W::new(self)
    }
